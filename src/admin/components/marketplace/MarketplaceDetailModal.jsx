...
export default function MarketplaceDetailModal({ isOpen, onClose, data, type = 'job' }) {
  ...
  const getIcon = () => {
    switch (type) {
      case 'job': return <Briefcase className="text-brand-500" />;
      case 'gig': return <ShoppingBag className="text-brand-500" />;
      ...
      >
          ...
          <div className="grid grid-cols-2 gap-8 pt-4 border-t border-zinc-100 dark:border-zinc-800">
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 bg-brand-100 dark:bg-brand-900/30 rounded-xl flex items-center justify-center text-brand-600 font-bold">
        ...
        <div className="p-6 bg-surface dark:bg-zinc-800/30 border-t border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <button className="px-6 py-2.5 bg-brand-600 hover:bg-brand-700 text-white rounded-xl text-sm font-black shadow-lg shadow-brand-500/20 transition-all active:scale-95">
              Edit {type}
            </button>
          </div>
        </div>

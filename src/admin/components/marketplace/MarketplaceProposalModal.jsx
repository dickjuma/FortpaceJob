        ...
        <div className="p-10 space-y-10 max-h-[70vh] overflow-y-auto custom-scrollbar">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="p-4 bg-surface dark:bg-zinc-800/50 rounded-2xl border border-zinc-100 dark:border-zinc-800">
              ...
              <span className="text-[10px] font-black uppercase text-[#4C1D95] bg-[#4C1D95]/5 dark:bg-[#4C1D95]/10 px-2 py-0.5 rounded">
                {data.status}
              </span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-xs font-black text-zinc-900 dark:text-white uppercase tracking-widest flex items-center gap-2">
              <MessageCircle size={14} className="text-[#4C1D95]" />
          ...
          <div className="p-6 border border-zinc-100 dark:border-zinc-800 rounded-[2.5rem] flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="h-16 w-16 bg-[#4C1D95]/10 dark:bg-[#4C1D95]/30 rounded-2xl flex items-center justify-center text-[#4C1D95] text-2xl font-black">
          ...
          <div className="space-y-4">
             ...
             <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-white dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-700 rounded-2xl flex items-center justify-between group hover:border-[#4C1D95]/20 transition-colors">
                   ...
                   <Download size={16} className="text-zinc-300 group-hover:text-[#4C1D95] cursor-pointer" />
                </div>
                <div className="p-4 bg-white dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-700 rounded-2xl flex items-center justify-between group hover:border-[#4C1D95]/20 transition-colors">
                   <div className="flex items-center gap-3">
                      <div className="p-2 bg-surface dark:bg-surface-dark rounded-lg text-zinc-400"><FileText size={16} /></div>

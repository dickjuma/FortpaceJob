...
export default function AdminActionModal({ 
  ...
  const config = actionConfigs[actionType] || {
    ...
    icon: <Info className="text-[#14a800]" />,
    actionLabel: 'Confirm',
    color: 'bg-[#14a800]',
        ...
        <div className="p-8 pt-4 space-y-6">
          ...
          <div className="space-y-3">
            <label className="text-[10px] font-black text-zinc-400 uppercase tracking-widest px-1 flex items-center gap-2">
              <MessageSquare size={12} className="text-[#14a800]" />
            ...
            <textarea 
              ...
              rows={2}
              className="w-full px-6 py-4 bg-surface dark:bg-zinc-800 border-2 border-transparent focus:border-[#14a800]/20/20 rounded-2xl text-sm font-medium text-zinc-900 dark:text-white placeholder:text-zinc-400 outline-none transition-all resize-none shadow-inner"

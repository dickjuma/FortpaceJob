      ...
      >
        ...
        <div className="p-8 border-b border-zinc-100 dark:border-zinc-800 flex items-center justify-between bg-surface/50 dark:bg-zinc-800/30">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-brand-500 text-white rounded-2xl shadow-lg shadow-blue-500/20">
              <User size={24} />
            </div>
            <div>
        ...
        <form onSubmit={handleSubmit} className="p-10 space-y-8">
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -tranzinc-y-1/2 text-zinc-400 group-focus-within:text-brand-500 transition-colors" size={16} />
                <input 
                  type="text" 
                  value={formData.fullName}
                  onChange={e => setFormData({...formData, fullName: e.target.value})}
                  className="w-full pl-12 pr-4 py-3 bg-surface dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-800 rounded-2xl text-sm font-bold outline-none focus:border-brand-500 transition-all"
                />
              </div>
            </div>
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <Mail className="absolute left-4 top-1/2 -tranzinc-y-1/2 text-zinc-400 group-focus-within:text-brand-500 transition-colors" size={16} />
                <input 
                  type="email" 
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-1.5">
              ...
              <select 
                ...
                className="w-full px-4 py-3 bg-surface dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-800 rounded-2xl text-sm font-bold outline-none focus:border-brand-500 transition-all appearance-none cursor-pointer"
              >
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <Smartphone className="absolute left-4 top-1/2 -tranzinc-y-1/2 text-zinc-400 group-focus-within:text-brand-500 transition-colors" size={16} />
                <input 
                  type="tel" 
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <Globe className="absolute left-4 top-1/2 -tranzinc-y-1/2 text-zinc-400 group-focus-within:text-brand-500 transition-colors" size={16} />
                <input 
                  type="text" 
          ...
          <div className="pt-4 flex gap-4">
            ...
            <button 
              type="submit"
              className="flex-2 px-12 py-4 bg-brand-600 hover:bg-brand-700 text-white rounded-2xl text-sm font-black shadow-xl shadow-blue-500/20 flex items-center justify-center gap-2 transition-all active:scale-95"
            >
              <Save size={18} />
              Save Updates
            </button>

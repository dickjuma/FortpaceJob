      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white dark:bg-surface-dark border border-zinc-100 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
        <div className="relative flex-1 w-full sm:w-auto">
          ...
          <input 
            ...
            className="w-full h-12 pl-12 pr-4 bg-surface dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-800 rounded-2xl text-sm font-medium outline-none focus:border-[#4C1D95]/20 transition-all"
          />
        </div>
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-2 px-6 h-12 bg-surface-dark text-white border border-transparent rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-[#4C1D95] transition-all shadow-lg shadow-zinc-900/10">
            <Download size={16} />
            Export CSV
          </button>
        </div>

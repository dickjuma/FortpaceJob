...
const FinancialControl = () => {
  ...
  if (isLoading) return (
    <div className="p-8 flex items-center justify-center">
      <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#14a800]/20" />
    </div>
  );
    ...
    <div className="space-y-8 animate-in slide-in-from-right-4 duration-500">
      ...
      <div className="bg-white dark:bg-[#222222] rounded-[24px] border border-zinc-200 dark:border-white/10 shadow-sm overflow-hidden p-6 md:p-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="flex items-center gap-2 bg-success text-white px-4 py-2 rounded-xl text-sm font-bold shadow-lg shadow-[#14a800]/20">
            <Percent size={16} />
            New Rule
          </button>
        </div>

...
export default function FraudDetectionCenter() {
  ...
  const VECTOR_COLORS = ['bg-red-500', 'bg-orange-500', 'bg-yellow-500', 'bg-[#4C1D95]', 'bg-#4C1D95]'];

  return (
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <Link to="/admin/moderation" className="text-sm font-medium text-[#4C1D95] hover:text-[#4C1D95] mb-4 inline-flex items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm flex items-center">
          <div className="w-12 h-12 bg-[#4C1D95]/10 dark:bg-[#4C1D95]/30 text-[#4C1D95] rounded-xl flex items-center justify-center mr-4 shrink-0">

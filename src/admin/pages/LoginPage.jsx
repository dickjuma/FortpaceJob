...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-white selection:bg-[#14a800]/10 selection:text-[#14a800]">
      <div className="hidden lg:flex flex-col justify-between p-16 bg-surface-dark text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-12">
             <div className="h-10 w-10 bg-[#14a800] rounded-2xl flex items-center justify-center text-white shadow-xl shadow-[#14a800]/25/20">
                <ShieldCheck size={24} />
             </div>
             <span className="text-xl font-black tracking-tight">Forte<span className="text-[#14a800]">Admin</span></span>
          </div>
          <h1 className="text-6xl font-black leading-[1.1] tracking-tighter mb-6 max-w-md">
             The brain behind the <span className="text-[#14a800] underline decoration-#14a800] underline-offset-8">marketplace.</span>
          </h1>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
               <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                     <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-[#14a800] transition-colors" size={18} />
                     <input 
                        type="email" 
                        placeholder="admin@forte.ke"
                        value={email}
                        onChange={(e) => setEmail(e.target.value)}
                        className="w-full pl-12 pr-4 h-14 bg-surface dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-800 rounded-2xl outline-none focus:border-[#14a800]/20 dark:focus:border-[#14a800]/20 transition-all"
                      />
                  </div>
               </div>
               ...
               <div className="space-y-1.5">
                  ...
                  <div className="relative group">
<Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-[#14a800] transition-colors" size={18} />
                      <input
                         type={showPassword ? 'text' : 'password'}
                         placeholder="••••••••"
                         value={password}
                         onChange={(e) => setPassword(e.target.value)}
                         className="w-full pl-12 pr-12 h-14 bg-surface dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-800 rounded-2xl outline-none focus:border-[#14a800]/20 dark:focus:border-[#14a800]/20 transition-all"
                      />
                      <button
                         type="button"

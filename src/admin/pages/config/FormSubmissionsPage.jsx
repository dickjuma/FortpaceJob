    ...
    <div className="space-y-6 max-w-5xl pb-10">
      ...
      <div className="flex gap-2">
        <button
          ...
          className={`px-4 py-2 rounded-xl text-sm font-bold ${tab === 'contact' ? 'bg-[#4C1D95] text-white' : 'bg-zinc-100'}`}
        >
          Contact
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-xl text-sm font-bold flex items-center gap-2 ${tab === 'chatbot' ? 'bg-[#4C1D95] text-white' : 'bg-zinc-100'}`}
        >
              ...
              <li key={row.id} className="p-5 hover:bg-zinc-50 dark:hover:bg-zinc-900/50">
                ...
                {row.status === 'NEW' && (
                  <button
                    ...
                    className="mt-3 text-xs font-bold text-[#4C1D95] hover:underline"
                  >
                    Mark as read
                  </button>
                )}

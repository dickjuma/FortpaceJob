    ...
    <div className="space-y-6 max-w-4xl pb-10">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <button 
          onClick={handleSave}
          disabled={isUpdating}
          className="px-5 py-2.5 bg-surface-dark text-white dark:bg-[#14a800] rounded-xl text-sm font-bold shadow-sm hover:bg-zinc-800 transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input 
                ...
                className="w-full px-4 py-3 bg-surface dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl font-bold text-zinc-900 dark:text-white outline-none focus:ring-2 focus:ring-[#14a800]" 
              />
            </div>
            <div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea 
                ...
                onChange={handleChange}
                rows="3"
                className="w-full px-4 py-3 bg-surface dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl font-medium text-zinc-900 dark:text-white outline-none focus:ring-2 focus:ring-[#14a800] resize-none" 
              />
            </div>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
        <div className="p-6 border-b border-zinc-100 dark:border-zinc-800 flex justify-between items-center">
          ...
          <button
            ...
            disabled={isSaving}
            className="px-4 py-2 bg-[#14a800] text-white rounded-xl text-sm font-bold disabled:opacity-50"
          >

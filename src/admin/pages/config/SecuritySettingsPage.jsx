    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      {activeTab === 'audit' ? (
          ...
          <div className="space-y-4">
             <div className="p-4 bg-surface dark:bg-zinc-800 rounded-2xl flex items-center justify-between border border-dashed border-zinc-300 dark:border-zinc-700">
                <div className="flex items-center gap-3">
                 ...
                 <button onClick={() => rotateMutation.mutate()} disabled={rotateMutation.isPending} className="p-2 text-[#14a800] hover:bg-[#14a800]/5 rounded-xl transition-colors disabled:opacity-50">
        ...
        <button 
          onClick={handleSave}
          disabled={isUpdating}
          className="w-full py-4 bg-surface-dark text-white dark:bg-[#14a800] rounded-2xl font-black text-sm shadow-xl hover:bg-zinc-800 transition-all active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-50"
        >

                  ...
                  <tr key={contract.id} className="hover:bg-surface/50 dark:hover:bg-zinc-800/20 transition-colors">
                    <td className="p-4 text-center">
                      <input 
                        ...
                        className="rounded border-zinc-300 dark:border-zinc-600 text-brand-600"
                      />
                    </td>
                    <td className="p-4">
                    ...
                    <td className="p-4">
                      ...
                      >
                        ...
                        <span className="text-sm font-medium text-zinc-900 dark:text-white group-hover:text-brand-600 transition-colors">{contract.freelancerName}</span>
                      </div>
                    </td>
                    <td className="p-4">
                      <div 
                      ...
                      >
                        ...
                        <span className="text-sm font-medium text-zinc-900 dark:text-white group-hover:text-brand-600 transition-colors">{contract.clientName}</span>
                      </div>
                    </td>
                    <td className="p-4">
                    ...
                    <td className="p-4">
                      <div className="flex flex-col gap-1 w-24">
                        <div className="flex justify-between text-[10px] font-bold">
                          <span className="text-brand-600">{contract.progress}%</span>
                          <span className="text-zinc-400">{contract.completedMilestones}/{contract.milestones}</span>
                        </div>
                        <div className="h-1.5 w-full bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden">
                          <div className="h-full bg-brand-500 rounded-full" style={{ width: `${contract.progress}%` }} />
                        </div>
                      </div>
                    </td>
                    <td className="p-4">
                    ...
                    <td className="p-4 text-right">
                      <div className="flex items-center justify-end gap-2 pr-2">
                        <button 
                          ...
                          className="p-2 text-brand-600 bg-brand-50 hover:bg-brand-100 dark:bg-brand-900/40 dark:text-brand-300 rounded-xl transition-all shadow-sm border border-brand-100 dark:border-brand-800" title="View Details"
                        >
                          <Eye size={18} />
                        </button>
                        <button 

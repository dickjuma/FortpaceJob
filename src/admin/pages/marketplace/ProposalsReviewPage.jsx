            ...
            <thead>
              <tr className="bg-surface dark:bg-zinc-800/50 text-zinc-500 dark:text-zinc-400 text-xs uppercase tracking-wider font-semibold">
                <th className="p-4 w-12 text-center">
                  <input type="checkbox" onChange={toggleAll} checked={selectedIds.length > 0 && selectedIds.length === proposalsData?.data?.length} className="rounded border-zinc-300 dark:border-zinc-600 text-[#2bb75c] focus:ring-[#2bb75c]" />
                </th>
                ...
                proposalsData?.data?.map(proposal => (
                  <tr key={proposal.id} className="hover:bg-surface/50 dark:hover:bg-zinc-800/20">
                    <td className="p-4 text-center">
                      <input type="checkbox" checked={selectedIds.includes(proposal.id)} onChange={() => toggleSelect(proposal.id)} className="rounded border-zinc-300 dark:border-zinc-600 text-[#2bb75c]" />
                    </td>
                    <td className="p-4">
                      <div>
                    ...
                    <td className="p-4">
                      ...
                      >
                        ...
                        <div>
                          <p className="text-sm font-semibold text-zinc-900 dark:text-white group-hover:text-[#2bb75c] transition-colors">{proposal.freelancerName}</p>
                          <div 
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-2 w-24">
                        <div className="h-1.5 w-full bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden">
                          <div className={cn("h-full rounded-full", proposal.matchScore > 80 ? "bg-success" : "bg-[#2bb75c]")} style={{ width: `${proposal.matchScore}%` }} />
                        </div>
                    ...
                    <td className="p-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button 
                          ...
                          className="p-1.5 text-[#2bb75c] bg-[#2bb75c]/5 hover:bg-[#2bb75c]/10 dark:bg-[#2bb75c]/20 dark:hover:bg-[#2bb75c]/40 rounded-lg transition-colors tooltip-trigger" title="View Proposal"
                        >
                          <Eye size={16} />
                        </button>

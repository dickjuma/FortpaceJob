    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
         {[
           ...
           { label: 'Frozen Funds', value: '$8,240', icon: Lock, color: 'text-[#2bb75c]', bg: 'bg-[#2bb75c]/10' },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
         <div className="lg:col-span-2 bg-gradient-to-br from-[#2bb75c]/20 to-zinc-900/20 p-8 rounded-3xl border border-[#2bb75c]/20/10 flex flex-col md:flex-row items-center gap-8 relative overflow-hidden group">
            <div className="absolute top-0 right-0 p-8 text-[#2bb75c]/5 -mr-8 -mt-8 rotate-12 transition-transform group-hover:scale-110">
            ...
            <div className="space-y-4 relative z-10">
               ...
               <button className="flex items-center gap-2 text-[#2bb75c] text-xs font-black uppercase tracking-widest hover:text-[#2bb75c] transition-colors">
                  View Rules Engine <ChevronRight size={14} />
               </button>
            </div>
            <div className="shrink-0 relative z-10">
               <div className="h-32 w-32 rounded-full border-4 border-[#2bb75c]/20/20 flex items-center justify-center p-2">
                  <div className="h-full w-full rounded-full border-4 border-[#2bb75c]/20/40 flex items-center justify-center p-2 animate-spin-slow">
                     <div className="h-full w-full rounded-full bg-[#2bb75c] flex items-center justify-center text-white font-black text-xl shadow-[0_0_20px_rgba(99,102,241,0.5)]">
                        94%
                     </div>
                  </div>
               </div>

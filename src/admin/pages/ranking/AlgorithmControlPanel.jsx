      ...
      <div className="mb-8 flex justify-between items-center border-b border-gray-200 dark:border-surface-dark-border pb-6">
        <div>
          <h1 className="text-3xl font-bold text-surface-dark dark:text-white flex items-center gap-3">
            <Sliders className="w-8 h-8 text-[#14a800]" /> AI Algorithm Weights Control
          </h1>
        ...
        <div className="flex gap-3">
          <button className="px-4 py-2 border border-[#14a800]/20 text-[#14a800] bg-[#14a800]/5 rounded-lg text-sm font-bold flex items-center">
            <RefreshCw className="w-4 h-4 mr-2" /> Run Simulation
          </button>
          <button className="px-6 py-2 bg-[#14a800] hover:bg-[#118a00] text-white rounded-lg text-sm font-bold shadow-md">
            Deploy Live
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white dark:bg-surface-dark border border-gray-200 dark:border-surface-dark-border rounded-2xl shadow-card overflow-hidden">
            ...
            <div className="p-6 space-y-8">
              {[
                { key: 'skillRelevance', label: 'Skill Match Relevance', desc: 'Weight of keyword/semantic skill matching', color: 'bg-[#14a800]' },
        ...
        <div className="space-y-6">
          <div className="bg-surface-dark text-white rounded-2xl p-6 shadow-card border border-surface-dark-border">
            <h3 className="font-bold text-lg mb-4 flex items-center gap-2"><Activity className="w-5 h-5 text-[#14a800]" /> Simulation Forecast</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center text-sm">
                ...
                <span className="font-bold text-[#14a800]">+1.2%</span>
              </div>
            </div>

            <div className="mt-6 pt-6 border-t border-surface-dark-tertiary">
              <div className="flex items-start gap-3 p-3 bg-[#14a800]/30 rounded-xl border border-[#14a800]/20/50">
                <Shield className="w-5 h-5 text-[#14a800] shrink-0 mt-0.5" />

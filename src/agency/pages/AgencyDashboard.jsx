...
export default function AgencyDashboard() {
  const stats = [
    ...
    { label: 'Active Contracts', value: '14', icon: Briefcase, color: 'text-[#4C1D95]', bg: 'bg-[#4C1D95]/5 dark:bg-[#4C1D95]/20' },
    { label: 'Billed Hours (This Week)', value: '340h', icon: Activity, color: 'text-[#4C1D95]', bg: 'bg-[#4C1D95]/5 dark:bg-[#4C1D95]/20' },
    { label: 'Available Capacity', value: '25%', icon: Users, color: 'text-[#4C1D95]', bg: 'bg-[#4C1D95]/5 dark:bg-[#4C1D95]/20' },
  ];
    ...
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 space-y-4 md:space-y-0">
        ...
        <div className="flex space-x-3">
          ...
          <Link to="/freelancer/jobs">
            <button className="px-4 py-2 bg-[#4C1D95] border border-transparent rounded-lg text-sm font-medium text-white shadow-sm shadow-[#4C1D95]/25/30 hover:bg-[#22C55E] transition-all flex items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center">
                <Briefcase className="w-5 h-5 mr-2 text-[#4C1D95]" /> High-Value Contracts
              </h2>
            </div>
                    ...
                    <div>
                      ...
                      <div className="mt-3 flex items-center">
                        <div className="flex -space-x-2 mr-3">
                          <div className="w-8 h-8 rounded-full border-2 border-white dark:border-gray-900 bg-[#4C1D95] flex items-center justify-center text-xs text-white font-bold">JD</div>
                          <div className="w-8 h-8 rounded-full border-2 border-white dark:border-gray-900 bg-[#4C1D95] flex items-center justify-center text-xs text-white font-bold">AS</div>
                        ...
                        <span className="text-xs font-medium text-[#4C1D95] bg-[#4C1D95]/5 dark:bg-[#4C1D95]/30 px-2 py-1 rounded">On Track</span>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="text-lg font-bold text-gray-900 dark:text-white">$45,000</p>
                      <button className="mt-2 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-[#4C1D95]">View Timesheets</button>
                    </div>
                  </div>
                </li>
              ))}
        ...
        <div className="space-y-8">
          <div className="bg-gradient-to-br from-[#4C1D95] to-[#22C55E] rounded-2xl p-6 shadow-sm text-white">
            <h2 className="text-lg font-bold flex items-center mb-2">
              <Zap className="w-5 h-5 mr-2 text-yellow-300" /> Dispatch Center
            </h2>
            <p className="text-sm text-[#4C1D95] mb-6">You have 3 team members currently on the bench. We found 8 enterprise jobs matching their exact skills.</p>
            <button className="w-full py-2.5 bg-white text-[#4C1D95] rounded-lg text-sm font-bold shadow-sm hover:bg-surface transition-all">

  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden mb-8">
        <div className="h-40 bg-gradient-to-r from-blue-700 to-[#1d8d38]"></div>
        <div className="px-6 sm:px-10 pb-8">
          <div className="relative flex justify-between items-end -mt-16 mb-6">
            <div className="flex items-end space-x-5">
              <div className="relative">
                ...
                <div className="absolute -bottom-2 -right-2 bg-white dark:bg-gray-900 rounded-full p-1">
                  <ShieldCheck className="w-8 h-8 text-[#2bb75c]" />
                </div>
              </div>
              <div className="pb-2">
            ...
            <div className="pb-2 flex space-x-3">
              <button className="px-6 py-2.5 bg-[#2bb75c] text-white font-bold text-sm rounded-lg shadow-sm shadow-[#2bb75c]/25/30 hover:bg-[#1d8d38] transition-colors">
                Hire Agency
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 pt-6 border-t border-gray-100 dark:border-gray-800">
            ...
            <div className="flex flex-wrap gap-2 items-start justify-end">
              {agencyData.badges.map(badge => (
                <span key={badge} className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-[#2bb75c]/5 text-[#2bb75c] dark:bg-[#2bb75c]/30 dark:text-[#2bb75c] border border-[#2bb75c]/20 dark:border-[#2bb75c]/20">
        ...
        <div className="space-y-8">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800 shadow-sm">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-6 flex items-center">
              <Users className="w-5 h-5 mr-2 text-[#2bb75c]" /> Agency Roster
            </h2>
            <ul className="space-y-4">
              {agencyData.teamMembers.map((member, idx) => (
                <li key={idx} className="flex items-center justify-between p-3 hover:bg-surface dark:hover:bg-gray-800 rounded-xl transition-colors cursor-pointer border border-transparent hover:border-gray-200 dark:hover:border-gray-700">
                  <div className="flex items-center">
                    <div className="w-10 h-10 bg-[#2bb75c]/10 dark:bg-[#2bb75c]/50 text-[#2bb75c] rounded-full flex items-center justify-center font-bold mr-3">
                      {member.name[0]}
                    </div>
                    <div>
            ...
            <button className="w-full mt-4 py-2 text-sm font-bold text-[#2bb75c] bg-[#2bb75c]/5 dark:bg-[#2bb75c]/20 rounded-lg hover:bg-[#2bb75c]/10 transition-colors">
              View All 24 Members
            </button>
          </div>
        </div>

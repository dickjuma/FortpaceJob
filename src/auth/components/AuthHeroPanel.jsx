    ...
    <div className={panelClasses}>
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <motion.div 
          ...
          className="absolute -top-[20%] -left-[10%] w-[70%] h-[70%] rounded-full bg-brand-600/20 blur-[120px]" 
        />
        <motion.div 
          animate={{ 
            scale: [1, 1.5, 1],
      ...
      <div className="relative z-10">
        ...
        >
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-600 shadow-lg shadow-brand-500/30 xl:h-11 xl:w-11">
            <ShieldCheck className="h-6 w-6 text-white" />
          </div>
          <span className="text-xl font-bold tracking-tight xl:text-2xl">Forte<span className="text-brand-500">.</span></span>
        </motion.div>
      ...
      {stats && (
        <div className="relative z-10 mt-8 space-y-4">
          ...
          <div className="grid max-w-lg grid-cols-1 gap-3">
            ...
            >
              <TrendingUp className="mb-3 h-6 w-6 text-brand-400" />

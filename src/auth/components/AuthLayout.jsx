...
export default function AuthLayout({ 
  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface dark:bg-surface-dark text-zinc-900 dark:text-zinc-50 selection:bg-[#14a800]/30 lg:flex-row">
      ...
      <div className={`${contentClasses} relative overflow-y-auto custom-scrollbar`}>
        ...
        <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#14a800]/5 rounded-full blur-[100px]" />
        ...
        <div className="lg:hidden absolute top-6 left-6 flex items-center gap-2">
          ...
          <span className="font-bold tracking-tight">Forte<span className="text-[#14a800]">.</span></span>
        </div>
      </div>
    </div>
  );

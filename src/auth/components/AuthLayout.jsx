...
export default function AuthLayout({ 
  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface dark:bg-surface-dark text-zinc-900 dark:text-zinc-50 selection:bg-brand-500/30 lg:flex-row">
      ...
      <div className={`${contentClasses} relative overflow-y-auto custom-scrollbar`}>
        ...
        <div className="lg:hidden absolute top-6 left-6 flex items-center gap-2">
          ...
          <span className="font-bold tracking-tight">Forte<span className="text-brand-600">.</span></span>
        </div>
      </div>
    </div>
  );

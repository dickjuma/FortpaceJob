    ...
    <div className="w-full">
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="bg-white px-3 text-xs font-medium uppercase tracking-wider text-zinc-500 dark:bg-zinc-950 dark:text-zinc-400">
            Or continue with
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        {buttons.map((btn) => (
          <motion.button
            ...
            className={`
              flex items-center justify-center gap-2 rounded-2xl border border-zinc-200 bg-white/90 px-4 py-3 text-sm font-medium transition-all
              hover:-tranzinc-y-0.5 hover:border-zinc-300 hover:bg-zinc-50 hover:shadow-sm
              dark:border-zinc-700 dark:bg-zinc-900/60 dark:hover:border-zinc-600 dark:hover:bg-zinc-900
              disabled:opacity-50 disabled:cursor-not-allowed
            `}
            aria-label={`Continue with ${btn.name}`}
          >

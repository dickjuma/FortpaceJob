...
import { ArrowLeft, CheckCircle2, Star, Shield, Zap } from 'lucide-react';
...
const Step3RegistrationDetails = () => {
  ...
  const onSubmit = async (data) => {
    ...
    console.log('Final Registration Data:', { accountType, businessStructure, ...data });
  ...
  return (
    <motion.div 
      ...
      exit={{ opacity: 0 }}
      className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row bg-white dark:bg-zinc-900 rounded-[2.5rem] shadow-2xl shadow-indigo-500/10 overflow-hidden border border-zinc-200/50 dark:border-zinc-800/50 mt-4"
    >
      {/* Left Panel - Branding & Social Proof */}
      <div className="hidden lg:flex lg:w-5/12 bg-gradient-to-br from-indigo-600 to-blue-700 p-12 flex-col justify-between relative overflow-hidden text-white">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 bg-white/10 p-4 rounded-2xl backdrop-blur-sm border border-white/10">
              ...
              <div>
                ...
                <p className="text-sm text-indigo-100">Bank-grade encryption & protection</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-white/10 p-4 rounded-2xl backdrop-blur-sm border border-white/10">
              ...
              <div>
                ...
                <p className="text-sm text-indigo-100">Optimized workflows and hiring</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 mt-12 bg-black/20 p-6 rounded-2xl backdrop-blur-md border border-white/10">
          ...
          <p className="text-sm text-indigo-50 italic mb-4">
            "Forte completely transformed how we build our remote engineering team. The quality of talent is unmatched."
          </p>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-indigo-300 rounded-full flex items-center justify-center text-indigo-800 font-bold">
              JD
            </div>
            <div>
              <p className="text-sm font-bold">John Doe</p>
              <p className="text-xs text-indigo-200">CTO, TechCorp</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-7/12 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
        ...
        <p className="text-zinc-500 mb-8">
          Setting up as a <strong className="text-indigo-600 dark:text-indigo-400 capitalize">{accountType}</strong> ({businessStructure}).
        </p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-8">
          ...
          <div className="mt-8 flex items-start gap-3">
            ...
            <label htmlFor="terms" className="text-sm text-zinc-500 dark:text-zinc-400">
              I agree to the <a href="/terms" className="font-semibold text-indigo-600 hover:underline dark:text-indigo-500">Terms and Conditions</a> and <a href="/privacy" className="font-semibold text-indigo-600 hover:underline dark:text-indigo-500">Privacy Policy</a>.
            </label>
          </div>
          ...
          <button
            ...
            className={`mt-8 w-full flex items-center justify-center px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 ${
              isSubmitting 
                ...
                : 'bg-indigo-600 hover:bg-indigo-700 text-white shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 hover:-tranzinc-y-0.5'
            }`}
          >

        ...
        {Array.from({ length }).map((_, index) => (
          ...
          >
              ...
              className={`
                ...
                ${error 
                  ...
                  : isComplete
                    ...
                    : 'border-zinc-200 bg-white/50 dark:bg-surface-dark/50 backdrop-blur-sm focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 dark:border-zinc-700 dark:text-white dark:focus:border-brand-500'
                }
                border shadow-sm
            ...
            {focusedIndex === index && !isComplete && !error && (
              <motion.div 
                layoutId="otp-focus"
                className="absolute -bottom-2 left-1/2 -tranzinc-x-1/2 w-1.5 h-1.5 rounded-full bg-brand-500"
              />
            )}
          </motion.div>
        ))}

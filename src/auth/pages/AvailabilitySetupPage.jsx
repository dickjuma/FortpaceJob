  ...
  return (
    <div className="min-h-screen bg-surface dark:bg-surface-dark font-sans selection:bg-brand-500/30 overflow-x-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] rounded-full bg-brand-500/5 blur-[120px]" />
      </div>
        ...
        <div className="flex-1 w-full max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h1 className="text-3xl sm:text-4xl font-extrabold text-zinc-900 dark:text-white tracking-tight mb-3">
              Set your <span className="bg-gradient-to-r from-emerald-500 to-brand-500 bg-clip-text text-transparent">availability</span>
            </h1>
            ...
            <div className="bg-white dark:bg-surface-dark rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                {[
                  ...
                  >
                    <type.icon className={cn("w-6 h-6 mb-2", commitment === type.id ? "text-brand-500" : "text-zinc-400")} />
              ...
              {commitment !== 'project' && (
                <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="mt-6 pt-6 border-t border-zinc-100 dark:border-zinc-800">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="text-lg font-black text-brand-600">{hours} hrs</span>
                  </div>
                  <input 
                    type="range" 
                    min="1" max="60" 
            ...
            <div className="bg-white dark:bg-surface-dark rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm overflow-hidden">
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              ...
                              isSelected 
                                ? "bg-brand-500 border-brand-500 shadow-sm shadow-brand-500/20" 
                                : "bg-surface dark:bg-zinc-800/50 border-zinc-100 dark:border-zinc-700/50 hover:border-brand-300 dark:hover:border-brand-700"
                            )}
                          />
                        );
                      })}
              ...
              <div className="mt-4 pt-4 border-t border-zinc-100 dark:border-zinc-800 flex justify-between items-center text-xs">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded bg-brand-500" /> <span className="text-zinc-500 font-medium">Available</span>
        ...
        <div className="fixed bottom-0 left-0 right-0 border-t border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-surface-dark/80 backdrop-blur-md z-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-brand-600 hover:bg-brand-700 text-white text-sm font-bold rounded-xl shadow-sm transition-all"
            >

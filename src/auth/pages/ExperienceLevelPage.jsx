...
const EXPERIENCE_LEVELS = [
  ...
  },
  {
    ...
    bg: 'bg-brand-50 dark:bg-brand-950/25',
...
const SIDEBAR_STATS = [
  { icon: Users, label: 'Active freelancers', value: '150K+', color: 'text-brand-500' },
  { icon: DollarSign, label: 'Avg. monthly earnings', value: '$4,200', color: 'text-success' },
  { icon: Clock, label: 'Avg. time to first hire', value: '< 48 hrs', color: 'text-violet-500' },
  { icon: Star, label: 'Client satisfaction', value: '99.8%', color: 'text-amber-500' },
];

const DEMAND_DATA = [
  { level: 'Beginner', pct: 68, color: 'bg-success' },
  { level: 'Intermediate', pct: 85, color: 'bg-brand-500' },
...
function SkillSlider({ skill, onChange, accentColor }) {
  const colorMap = {
    ...
    blue: { track: 'bg-brand-500', thumb: 'accent-blue-600' },
  ...
  return (
    <aside className="w-full lg:w-80 xl:w-88 flex-shrink-0 space-y-5">
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-blue-600 to-violet-600 rounded-2xl p-5 shadow-lg shadow-blue-500/20"
      >
        <div className="flex items-center gap-2 mb-3">
          <Star className="w-4 h-4 text-amber-300 fill-amber-300" />
          <span className="text-xs font-extrabold text-white/90 uppercase tracking-wide">Success Story</span>
        </div>
        <p className="text-sm text-brand-100 leading-relaxed mb-3 italic">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <div className="text-[10px] text-brand-200">Full Stack Developer · Expert</div>
          </div>
...
export default function ExperienceLevelPage() {
  ...
  return (
    <div className="relative min-h-screen bg-surface dark:bg-surface-dark font-sans selection:bg-brand-500/30 overflow-x-hidden">
      {/* Floating orbs */}
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        <div className="absolute -top-40 -left-40 w-[600px] h-[600px] rounded-full bg-brand-500/8 blur-[130px]" />
        <div className="absolute top-1/3 -right-40 w-[500px] h-[500px] rounded-full bg-violet-500/8 blur-[130px]" />
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-extrabold text-zinc-900 dark:text-white tracking-tight mb-3">
            What's your{' '}
            <span className="bg-gradient-to-r from-blue-600 via-violet-500 to-amber-500 bg-clip-text text-transparent">
              experience level?
            </span>
          </h1>
              ...
              >
                ...
                <motion.button
                  ...
                  className={cn(
                    ...
                    canContinue
                      ? 'bg-gradient-to-r from-blue-600 to-violet-600 text-white shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/35'

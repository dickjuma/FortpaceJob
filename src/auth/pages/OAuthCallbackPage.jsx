  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface px-6">
      <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-xl border border-zinc-200 text-center">
        {!error ? (
          <>
            <Loader2 className="w-10 h-10 animate-spin mx-auto text-[#14a800] mb-4" />
          ...
          <>
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-xl bg-[#14a800] px-5 py-3 font-semibold text-white hover:bg-[#118a00] transition-colors"
            >
              Back to login
            </button>
          </>

...
const StepPill = ({ active, label, description }) => (
  <div
    className={cn(
      ...
      active
        ? 'border-[#14a800]/20 bg-[#14a800]/5 shadow-[0_14px_30px_rgba(20,168,0,0.08)]'
        : 'border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900'
    )}
  >
    <p className={cn('text-sm font-black uppercase tracking-[0.18em]', active ? 'text-[#14a800]' : 'text-zinc-400')}>
      {label}
    </p>
...
export default function ProfileCompletionPage() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-surface dark:bg-surface-dark px-6">
        <div className="max-w-lg rounded-3xl border border-zinc-200 bg-white p-8 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          <ShieldCheck className="mx-auto h-10 w-10 text-[#14a800]" />
          ...
          <button
            ...
            className="mt-6 inline-flex items-center gap-2 rounded-xl bg-[#14a800] px-5 py-3 text-sm font-bold text-white transition-colors hover:bg-[#118a00]"
          >
            Select role
  ...
  return (
    <div className="min-h-screen bg-surface dark:bg-surface-dark font-sans selection:bg-[#14a800]/30">
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        <div className="absolute -right-40 top-16 h-[34rem] w-[34rem] rounded-full bg-[#14a800]/5 blur-[120px]" />
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl flex-col pb-24">
        <header className="flex items-center justify-between px-4 py-5 sm:px-6">
          <motion.div initial={{ opacity: 0, x: -12 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#14a800] text-white shadow-lg shadow-[#14a800]/20">
              <ShieldCheck className="h-5 w-5" />
            </div>
            <div>
              <div className="text-lg font-black tracking-tight text-zinc-950 dark:text-white">Forte</div>
              <div className="text-xs font-semibold uppercase tracking-[0.24em] text-[#14a800]">Profile launch wizard</div>
            </div>
          </motion.div>
        ...
        <main className="grid flex-1 gap-8 px-4 sm:px-6 xl:grid-cols-[minmax(0,1fr)_24rem]">
              ...
              <div className="border-b border-zinc-200/80 px-6 py-6 dark:border-zinc-800">
                <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                  <div className="max-w-2xl">
                    <div className="inline-flex items-center gap-2 rounded-full border border-[#14a800]/15 bg-[#14a800]/5 px-3 py-1 text-xs font-black uppercase tracking-[0.25em] text-[#14a800]">
                  ...
                  <div className="min-w-[18rem] rounded-3xl border border-zinc-200 bg-zinc-50 px-5 py-4 dark:border-zinc-800 dark:bg-zinc-900/70">
                    ...
                    <div className="mt-3 h-2 overflow-hidden rounded-full bg-zinc-200 dark:bg-zinc-800">
                      <div
                        className="h-full rounded-full bg-gradient-to-r from-[#14a800] to-emerald-400 transition-all"
                ...
                <AnimatePresence mode="wait">
                      ...
                      <div className="grid gap-6 lg:grid-cols-[18rem_minmax(0,1fr)]">
                        <div className="rounded-[1.75rem] border border-zinc-200 bg-zinc-50 p-5 dark:border-zinc-800 dark:bg-zinc-900/60">
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-xs font-black uppercase tracking-[0.22em] text-[#14a800]">Avatar</p>
                              <h2 className="mt-2 text-lg font-black text-zinc-950 dark:text-white">Profile identity</h2>
                            </div>
                            <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#14a800]/10 text-[#14a800]">
                          ...
                          <div className="mt-6">
                            ...
                            <div className="mt-4 grid gap-3">
                              <button
                                ...
                                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#14a800] px-4 py-3 text-sm font-bold text-white transition-colors hover:bg-[#118a00] disabled:cursor-not-allowed disabled:opacity-60"
                              >
                              ...
                              <button
                                ...
                                className="inline-flex items-center justify-center gap-2 rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm font-bold text-zinc-700 transition-colors hover:border-[#14a800]/20 hover:text-[#14a800] dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-300"
                              >
                    ...
                    >
                      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
                        <div className="space-y-5 rounded-[1.75rem] border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-950">
                          <div>
                            <p className="text-xs font-black uppercase tracking-[0.22em] text-[#14a800]">Role foundation</p>
                        ...
                        <aside className="space-y-4 rounded-[1.75rem] border border-zinc-200 bg-zinc-50 p-5 dark:border-zinc-800 dark:bg-zinc-900/60">
                          <p className="text-xs font-black uppercase tracking-[0.22em] text-[#14a800]">Backend sync</p>
                  ...
                  {activeStep === 3 && (
                    ...
                    >
                      <div className="space-y-5 rounded-[1.75rem] border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-950">
                        <div>
                          <p className="text-xs font-black uppercase tracking-[0.22em] text-[#14a800]">Profile story</p>
                          <h2 className="mt-2 text-2xl font-black tracking-tight text-zinc-950 dark:text-white">
                      ...
                      <aside className="space-y-4 rounded-[1.75rem] border border-zinc-200 bg-zinc-50 p-5 dark:border-zinc-800 dark:bg-zinc-900/60">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-xs font-black uppercase tracking-[0.22em] text-[#14a800]">Live preview</p>
                  ...
                  {activeStep === 4 && (
                    ...
                    >
                      <div className="space-y-5 rounded-[1.75rem] border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-950">
                        <div>
                          <p className="text-xs font-black uppercase tracking-[0.22em] text-[#14a800]">Launch check</p>
                          <h2 className="mt-2 text-2xl font-black tracking-tight text-zinc-950 dark:text-white">
                        ...
                        <div className="rounded-2xl border border-dashed border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900/60">
                          ...
                          <ul className="mt-3 space-y-2 text-sm leading-6 text-zinc-600 dark:text-zinc-300">
                            <li className="flex items-center gap-2">
                              <Check className="h-4 w-4 text-[#14a800]" /> Your profile data is saved to the backend.
                            </li>
                            <li className="flex items-center gap-2">
                              <Check className="h-4 w-4 text-[#14a800]" /> The onboarding payment step creates your wallet.
                            </li>
                            <li className="flex items-center gap-2">
                              <Check className="h-4 w-4 text-[#14a800]" /> Once the backend reports complete, we send you to the dashboard.
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <aside className="space-y-4 rounded-[1.75rem] border border-zinc-200 bg-zinc-50 p-5 dark:border-zinc-800 dark:bg-zinc-900/60">
                        <p className="text-xs font-black uppercase tracking-[0.22em] text-[#14a800]">Backend checklist</p>
                        <div className="space-y-3">
          ...
          <aside className="space-y-5">
            <div className="rounded-[2rem] border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.22em] text-[#14a800]">Backend status</p>
                ...
                <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#14a800]/10 text-[#14a800]">
                  <ShieldCheck className="h-5 w-5" />
                </div>
              </div>

              <div className="mt-4 h-2 overflow-hidden rounded-full bg-zinc-200 dark:bg-zinc-800">
                <div className="h-full rounded-full bg-gradient-to-r from-[#14a800] to-emerald-400" style={{ width: `${progressValue}%` }} />
              </div>
            ...
            <div className="rounded-[2rem] border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
              <p className="text-xs font-black uppercase tracking-[0.22em] text-[#14a800]">Checklist</p>
              <div className="mt-4 space-y-3">
                {completionChecklist.map((item) => (
        ...
        <footer className="fixed bottom-0 left-0 right-0 z-20 border-t border-zinc-200 bg-white/90 backdrop-blur-xl dark:border-zinc-800 dark:bg-zinc-950/90">
          <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-4 sm:px-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              onClick={handleNext}
              disabled={isSaving}
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#14a800] px-6 py-3 text-sm font-black text-white transition-colors hover:bg-[#118a00] disabled:cursor-not-allowed disabled:opacity-70"
            >
  ...
  return (
    <label className="block">
      <span className="mb-2 flex items-center gap-2 text-sm font-bold text-zinc-900 dark:text-white">
        {Icon ? <Icon className="h-4 w-4 text-[#14a800]" /> : null}
        {label}
      </span>
      {multiline ? (
        <textarea
          rows={6}
          className={cn(
            'w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm text-zinc-900 outline-none transition-all placeholder:text-zinc-400 focus:border-[#14a800]/20 focus:ring-2 focus:ring-[#14a800]/10 dark:border-zinc-800 dark:bg-zinc-950 dark:text-white',
            props.className
          )}
          {...props}
        />
...
function SummaryCard({ title, items }) {
  return (
    <div className="rounded-3xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900/60">
      <p className="text-sm font-black uppercase tracking-[0.22em] text-[#14a800]">{title}</p>

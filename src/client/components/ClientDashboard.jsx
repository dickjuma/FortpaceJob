  ...
  <div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        ...
        <p className="text-3xl font-bold text-[#14a800]">5</p>
      </div>
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        <h3 className="font-semibold mb-2">Pending Orders</h3>
        <p className="text-3xl font-bold text-[#14a800]">3</p>
      </div>
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        <h3 className="font-semibold mb-2">Total Spent</h3>
        <p className="text-3xl font-bold text-[#14a800]">$2,450</p>
      </div>
    </div>
  </div>
);
...
const NavLink = ({ to, icon: Icon, label, badge }) => {
  ...
  return (
    ...
    >
      ...
      <span>{label}</span>
      {badge && (
        <span className="ml-auto bg-[#14a800] text-white text-xs rounded-full px-2 py-0.5">
          {badge}
        </span>
      )}
    </Link>

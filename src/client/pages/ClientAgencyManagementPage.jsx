          ...
          <div className="p-5 border-b border-zinc-800 flex justify-between items-center bg-zinc-900/80">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="bg-zinc-950 border border-zinc-700 rounded-lg pl-9 pr-4 py-2 text-sm focus:outline-none focus:border-indigo-500 text-zinc-200"
              />
            </div>
          </div>
          ...
          <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl p-5 backdrop-blur-md">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-zinc-950/50 border border-zinc-800 rounded-lg">
                ...
                <div className="h-4 w-8 bg-indigo-600 rounded-full relative cursor-pointer">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-zinc-950/50 border border-zinc-800 rounded-lg">
                ...
                <div className="flex h-2 rounded-full overflow-hidden mb-2">
                  <div className="bg-indigo-500 w-[70%]" title="Sub-contractor 70%"></div>
                  <div className="bg-purple-500 w-[20%]" title="Agency 20%"></div>
                  <div className="bg-zinc-600 w-[10%]" title="Platform 10%"></div>
                </div>
                <div className="flex justify-between text-xs text-zinc-500">
                  <span className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-indigo-500"></div> Worker (70%)</span>
                  <span className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-purple-500"></div> Agency (20%)</span>

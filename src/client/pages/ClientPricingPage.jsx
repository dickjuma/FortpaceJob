      ...
      >
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {plans.map((plan) => (
            ...
            >
              {plan.highlight && (
                <div className="absolute -top-3 left-1/2 -tranzinc-x-1/2 rounded-full bg-[#2B211F] px-3 py-1 text-xs font-medium text-white shadow-md">
                  Most Popular
                </div>
              )}
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-3xl border border-[#EDE3DB] bg-white p-6 shadow-sm">
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                ...
                >
                  Go To Jobs
                  <ArrowRight size={15} className="transition group-hover:tranzinc-x-1" />
                </Link>
              </div>
            </div>
          </div>

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-extrabold text-zinc-900 dark:text-white tracking-tight mb-2 flex items-center gap-3">
              <Building2 className="w-8 h-8 text-brand-500" /> Procurement Dashboard
            </h1>
          ...
          <div className="flex gap-2">
            ...
            <button className="px-4 py-2 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-lg shadow-sm transition-all flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white dark:bg-surface-dark rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
            <div className="flex justify-between items-start mb-4">
              <div className="p-2 bg-brand-50 dark:bg-brand-500/10 text-brand-500 rounded-lg"><DollarSign className="w-5 h-5" /></div>
          ...
          <div className="bg-white dark:bg-surface-dark rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
            <div className="flex justify-between items-start mb-4">
              <div className="p-2 bg-brand-50 dark:bg-brand-500/10 text-brand-500 rounded-lg"><Users className="w-5 h-5" /></div>
          ...
          <div className="bg-white dark:bg-surface-dark rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
            ...
            <div className="w-full bg-zinc-100 dark:bg-zinc-800 h-1.5 rounded-full overflow-hidden mt-3">
              <div className="bg-brand-500 h-full w-[68%] rounded-full"></div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-surface-dark rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
            ...
            <p className="text-xs text-brand-600 dark:text-brand-400 font-bold mt-2 cursor-pointer hover:underline">View Recommendations &rarr;</p>
          </div>
        </div>
            ...
            <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 shadow-sm">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-bold text-zinc-900 dark:text-white flex items-center gap-2">
                  <TrendingUp className="w-5 h-5 text-brand-500" /> Spend Forecast vs Actual
                </h2>
            ...
            <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
              <div className="p-6 border-b border-zinc-100 dark:border-zinc-800 flex justify-between items-center bg-surface/50 dark:bg-surface-dark/50">
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="Search vendors..." className="pl-9 pr-4 py-2 bg-white dark:bg-surface-dark border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm font-medium outline-none focus:border-brand-500 w-64 shadow-sm" />
                </div>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 shadow-sm">
              <h2 className="text-xl font-bold text-zinc-900 dark:text-white mb-6 flex items-center gap-2">
                <PieChart className="w-5 h-5 text-brand-500" /> Dept. Allocation
              </h2>
              
              <div className="flex justify-center mb-8">
                <div className="w-40 h-40 rounded-full border-[16px] border-zinc-100 dark:border-zinc-800 border-t-brand-500 border-r-purple-500 border-b-amber-500 relative">
              ...
              <div className="space-y-4">
                {[
                  { name: 'Engineering', amount: 120000, color: 'bg-brand-500' },
                  { name: 'Marketing', amount: 85000, color: 'bg-brand-500' },

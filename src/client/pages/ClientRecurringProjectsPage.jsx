        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-extrabold text-zinc-900 dark:text-white tracking-tight mb-2 flex items-center gap-3">
              <RefreshCw className="w-8 h-8 text-[#2bb75c]" /> Recurring Projects
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div className="bg-[#2bb75c]/5 dark:bg-[#2bb75c]/10 p-6 rounded-2xl border border-[#2bb75c]/20 dark:border-[#2bb75c]/20/20">
              <div className="flex items-start gap-3">
                <AlertCircle className="w-5 h-5 text-[#2bb75c] dark:text-[#2bb75c] shrink-0 mt-0.5" />
                <div>
                  <p className="text-sm font-bold text-[#2bb75c] dark:text-[#2bb75c] mb-1">Upcoming Billing</p>
                  <p className="text-xs font-medium text-[#2bb75c]/80 dark:text-[#2bb75c]/80">$150 will be charged on May 24 for "Weekly Blog Post".</p>
                </div>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col justify-between border-b md:border-b-0 md:border-r border-zinc-100 dark:border-zinc-800">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <span className="text-xs font-bold text-[#2bb75c] bg-[#2bb75c]/5 dark:bg-[#2bb75c]/10 px-2 py-1 rounded-md inline-block mb-2">
                        {job.frequency}
                      </span>
                  ...
                  <div className="flex items-center gap-6 mt-4 pt-4 border-t border-zinc-50 dark:border-zinc-800/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold text-zinc-900 dark:text-white flex items-center gap-1 leading-none">
                        <Calendar className="w-3.5 h-3.5 text-[#2bb75c]" /> {job.nextExecution}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="w-full lg:w-80 shrink-0 space-y-6">
          <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <input type="checkbox" defaultChecked className="mt-1 w-4 h-4 rounded text-[#2bb75c] focus:ring-[#2bb75c] border-zinc-300" />
                <div>

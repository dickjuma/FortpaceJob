        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-extrabold text-zinc-900 dark:text-white tracking-tight mb-2 flex items-center gap-3">
              <Bookmark className="w-8 h-8 text-[#4C1D95]" /> Saved Searches & Alerts
            </h1>
            <p className="text-zinc-500 font-medium">Automate your sourcing and get notified when new talent matches your criteria.</p>
          </div>
          <button className="px-6 py-3 bg-[#4C1D95] hover:bg-[#22C55E] text-white font-bold rounded-xl shadow-sm transition-all flex items-center gap-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 flex flex-col lg:flex-row gap-8">
            ...
            {searches.map(search => (
              <div 
                ...
                className={cn(
                  ...
                  search.isActive ? "border-[#4C1D95]/20 dark:border-[#4C1D95]/20/50" : "border-zinc-200 dark:border-zinc-800 opacity-75"
                )}
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    {search.newMatches > 0 && search.isActive && (
                      <span className="bg-[#4C1D95] text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-sm animate-pulse">
                ...
                <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-center gap-4 border-t sm:border-t-0 sm:border-l border-zinc-100 dark:border-zinc-800 pt-4 sm:pt-0 sm:pl-6 shrink-0">
                  ...
                  <div className="flex gap-2">
                    <button className="p-2 text-zinc-400 hover:text-[#4C1D95] transition-colors bg-surface dark:bg-zinc-800/50 rounded-lg"><Settings className="w-4 h-4" /></button>
        ...
        <div className="w-full lg:w-96 shrink-0 space-y-6">
          ...
          <div className="bg-gradient-to-br from-[#4C1D95] to-[#22C55E] rounded-3xl p-6 shadow-md text-white relative overflow-hidden">
            ...
            <p className="text-sm font-medium text-[#4C1D95] mb-6 relative z-10">We found 4 new freelancers matching your "Senior React Devs" search criteria in the last 24 hours.</p>
                ...
                <div key={s.name} className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-3 flex justify-between items-center hover:bg-white/20 transition-colors cursor-pointer">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-medium text-[#4C1D95]">{s.title}</p>
                    </div>
                  </div>
            ...
            <button className="w-full mt-4 py-3 bg-white text-[#4C1D95] font-bold rounded-xl shadow-sm transition-all flex items-center justify-center gap-2">

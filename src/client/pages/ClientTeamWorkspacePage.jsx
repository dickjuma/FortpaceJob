          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            >
              ...
              <button 
                ...
                className="px-4 py-2 bg-success hover:bg-success text-white rounded-xl text-sm font-bold transition-colors flex items-center gap-2 shadow-lg shadow-[#14a800]/10"
              >
                        ...
                        {approval.status === 'Pending' && (
                          <>
                            ...
                            <button 
                              ...
                              className="flex items-center justify-center w-10 h-10 rounded-full bg-success text-white hover:bg-success transition-colors shadow-lg shadow-[#14a800]/10"
                            >

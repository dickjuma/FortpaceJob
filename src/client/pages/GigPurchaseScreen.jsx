      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden">
            <div className="p-6 border-b border-gray-200 dark:border-gray-800">
              <h2 className="text-xl font-bold flex items-center">
                <Package className="w-5 h-5 mr-2 text-[#2bb75c]" /> Select Package
              </h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-gray-800">
              {Object.entries(packages).map(([key, pkg]) => (
                <div 
                  ...
                  className={`p-6 cursor-pointer transition-colors ${selectedPackage === key ? 'bg-[#2bb75c]/5 dark:bg-[#2bb75c]/20' : 'hover:bg-surface dark:hover:bg-gray-800/50'}`}
                >
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm sticky top-6">
            ...
            <button className="w-full py-4 bg-[#2bb75c] hover:bg-[#1d8d38] text-white rounded-xl font-bold text-lg transition-colors flex justify-center items-center shadow-lg shadow-[#2bb75c]/25/25 mb-4">
              Fund Escrow & Start <ChevronRight className="w-5 h-5 ml-2" />
            </button>

            <div className="flex items-start bg-[#2bb75c]/5 dark:bg-[#2bb75c]/20 p-4 rounded-xl border border-[#2bb75c]/20 dark:border-[#2bb75c]/20/50">
              <ShieldCheck className="w-5 h-5 text-[#2bb75c] dark:text-[#2bb75c] mt-0.5 shrink-0 mr-3" />
              <p className="text-xs text-[#2bb75c] dark:text-[#2bb75c]">

          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-gray-100 dark:border-gray-800">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center">
                <Users className="w-5 h-5 mr-2 text-brand-600" /> Review Proposals ({proposals.length})
              </h2>
            </div>
                ...
                <li key={proposal.id} className="p-6 hover:bg-surface dark:hover:bg-gray-800/50 transition-colors">
                  <div className="flex flex-col sm:flex-row justify-between">
                    <div className="flex items-start mb-4 sm:mb-0">
                      <div className="w-12 h-12 rounded-full bg-brand-100 dark:bg-brand-900/30 text-brand-600 flex items-center justify-center font-bold text-xl mr-4 border border-brand-200 dark:border-brand-800">
                        {proposal.name[0]}
                      </div>
                      <div>
                    ...
                    <div className="text-left sm:text-right">
                      ...
                      <p className="text-xl font-bold text-brand-600 dark:text-brand-400">{proposal.bid}</p>
                      <p className="text-xs text-gray-500 mt-1">{proposal.time}</p>
                    </div>
                  </div>
                  <div className="mt-6 flex flex-wrap gap-3">
                    <button className="flex items-center px-4 py-2 bg-brand-600 text-white text-sm font-medium rounded-lg hover:bg-brand-700 shadow-sm">

      ...
      <div className="mb-8 space-y-6">
        ...
        <div className="bg-white dark:bg-surface-dark border border-gray-200 dark:border-surface-dark-border rounded-2xl p-4 shadow-card flex flex-col md:flex-row gap-4 relative z-20">
          <div className="flex-1 relative">
            ...
            />
            <div className="absolute right-3 top-1/2 -translate-y-1/2 px-2 py-1 bg-[#14a800]/10 text-success text-xs font-bold rounded-md">
              AI Search
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <button className="px-6 py-3 bg-success hover:bg-[#118a00] text-white rounded-xl text-sm font-bold shadow-lg shadow-[#14a800]/25 flex items-center transition-all">
              Find Matches
            </button>
          </div>
        </div>
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
          ...
          <span className="px-4 py-2 bg-white dark:bg-surface-dark border border-gray-200 dark:border-surface-dark-border text-gray-600 dark:text-gray-300 rounded-full text-sm font-medium shrink-0 hover:border-[#14a800]/50 cursor-pointer transition-colors flex items-center">Available Now <CheckCircle className="w-4 h-4 ml-2 text-success" /></span>
          <span className="px-4 py-2 bg-white dark:bg-surface-dark border border-gray-200 dark:border-surface-dark-border text-gray-600 dark:text-gray-300 rounded-full text-sm font-medium shrink-0 hover:border-[#14a800]/50 cursor-pointer transition-colors">US Only</span>
          <span className="px-4 py-2 bg-white dark:bg-surface-dark border border-gray-200 dark:border-surface-dark-border text-gray-600 dark:text-gray-300 rounded-full text-sm font-medium shrink-0 hover:border-[#14a800]/50 cursor-pointer transition-colors">Top Rated Plus</span>
          <span className="px-4 py-2 bg-white dark:bg-surface-dark border border-gray-200 dark:border-surface-dark-border text-gray-600 dark:text-gray-300 rounded-full text-sm font-medium shrink-0 hover:border-[#14a800]/50 cursor-pointer transition-colors flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-gradient-to-br from-surface-dark to-surface-dark-secondary rounded-2xl p-6 shadow-card text-white relative overflow-hidden border border-surface-dark-border">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="pt-4 border-t border-gray-800">
                <button className="text-[#14a800] font-bold hover:text-[#118a00] flex items-center text-xs uppercase tracking-wider">
        ...
        <div className="lg:col-span-3 space-y-6">
          <div className="flex justify-between items-center px-2">
            ...
            <span className="text-sm text-[#14a800] font-bold cursor-pointer">Sort by: Match Score</span>
          </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex flex-col items-center gap-3 w-full md:w-48 shrink-0 border-r border-transparent md:border-gray-100 dark:md:border-surface-dark-border pr-0 md:pr-6">
                        ...
                        <div className="w-full space-y-2 mt-2">
                          <div className="flex justify-between items-center bg-[#14a800]/10 px-3 py-1.5 rounded-lg border border-[#14a800]/20">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          <span className="px-2.5 py-1 rounded-md text-[10px] font-black uppercase tracking-wider border border-success/20 bg-[#14a800]/10 text-success">
                      ...
                      <div className="flex flex-col gap-3 justify-center w-full md:w-32 shrink-0 border-t border-transparent md:border-gray-100 dark:md:border-surface-dark-border pt-4 md:pt-0 pl-0 md:pl-6 border-l">
                        <button className="w-full py-2.5 bg-success hover:bg-[#118a00] text-white rounded-lg text-sm font-bold shadow-md transition-colors">
                          Invite
                        </button>

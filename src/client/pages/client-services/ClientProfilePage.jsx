...
export default function ClientProfilePage() {
  return (
    <div className="space-y-6">
      <div className="rounded-[32px] border border-[#E5E7EB] bg-[radial-gradient(circle_at_top_left,_#FFFFFF,_#F2F2F2_42%,_#FFFFFF_100%)] p-6 shadow-[0_18px_45px_rgba(33,24,21,0.06)]">

...
import { gigAPI, publicAPI, userAPI } from '../../../platform/common/services/api';
import { extractList, gigCardFromApi, talentCardFromApi } from '../../../platform/common/utils/apiHelpers';
            ...
            <div className="bg-white border border-zinc-200 rounded-3xl p-6 md:p-8 shadow-sm mb-6">
              <div className="flex flex-col items-center text-center relative mb-6">
                ...
                <h1 className="text-2xl font-black text-zinc-900 mb-1 flex items-center justify-center gap-2">
                  {seller.name}
                  {seller.verified && <Verified className="w-5 h-5 text-[#4C1D95] fill-current bg-white rounded-full" />}
                </h1>

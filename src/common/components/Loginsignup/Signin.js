        ...
        <div className="max-w-md w-full bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-gray-100 transform transition-all hover:scale-[1.01] duration-300">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            >
              ...
              {loading && (
                <>
                  <span className="absolute inset-y-0 left-0 w-1/2 -tranzinc-x-full bg-white/10 blur-2xl animate-pulse" />
                  ...
                  <span className="absolute right-4 top-1/2 h-2 w-2 -tranzinc-y-1/2 rounded-full bg-white/85 animate-ping" />
                  <span className="absolute left-4 top-1/2 h-2 w-2 -tranzinc-y-1/2 rounded-full bg-white/65 animate-pulse" />
                </>
              )}
            </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl transition-all duration-200 ease-out">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                onClick={closeModal}
                className="w-full py-3 border border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-surface transition"
              >
                Close
              </button>
            </div>

              ...
              <form onSubmit={handleDetailsSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    {checkingEmail && (
                      <div className="absolute right-4 top-1/2 transform -tranzinc-y-1/2">
                        <Spinner />
                      </div>
                    )}
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-4 top-1/2 transform -tranzinc-y-1/2 text-gray-500 hover:text-[#D34079]"
                    >
          ...
          <div ref={otpContainerRef} tabIndex={-1} className="space-y-6 outline-none">
            ...
            {emailVerified ? (
              ...
              <button
                ...
                onClick={() => setOtpPhase(false)}
                disabled={loading}
                className="w-full py-4 border-2 border-gray-200 text-[#4A312F] font-semibold rounded-xl hover:bg-surface transition disabled:opacity-50"
              >
                Back to edit info
              </button>
            )}

    ...
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="bg-white border border-zinc-200 rounded-2xl p-6 mb-8">
        ...
        <div className="flex gap-3">
          ...
          <button type="button" onClick={handleCopy} disabled={!summary.referralLink} className="px-6 py-3 bg-[#14a800] text-white font-bold rounded-xl disabled:opacity-50 flex items-center gap-2">

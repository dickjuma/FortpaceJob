      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-6 relative z-20 flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-[400px] shrink-0 space-y-6">
          ...
          <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
            ...
            <button className="w-full py-3 border-2 border-dashed border-zinc-300 dark:border-zinc-700 rounded-xl font-bold text-[#4C1D95] hover:bg-surface dark:hover:bg-zinc-800 transition-colors flex items-center justify-center gap-2 text-sm">
        ...
        <div className="flex-1 flex flex-col space-y-6">
          ...
          <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-sm flex-1 flex flex-col overflow-hidden min-h-[500px]">
              ...
              {CHAT_MESSAGES.map(msg => (
                <div key={msg.id} className={cn("flex flex-col max-w-[80%]", msg.role === 'client' ? "ml-auto items-end" : "mr-auto items-start")}>
                  ...
                  <div className={cn(
                    ...
                    msg.role === 'mediator' ? "bg-[#4C1D95]/5 dark:bg-[#4C1D95]/10 border border-[#4C1D95]/20 dark:border-[#4C1D95]/20 text-[#4C1D95] dark:text-[#4C1D95]" :
                    ...
                    {msg.role === 'mediator' && <Scale className="w-4 h-4 text-[#4C1D95] mb-2" />}
                    {msg.text}
                  </div>
                </div>
              ))}
            ...
            <div className="p-4 bg-white dark:bg-surface-dark border-t border-zinc-200 dark:border-zinc-800 shrink-0">
              <div className="flex items-end gap-2 bg-surface dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-3xl p-2 focus-within:border-[#4C1D95]/20 transition-colors">
                ...
                />
                <button className="p-2.5 bg-[#4C1D95] hover:bg-[#22C55E] text-white rounded-full transition-colors shrink-0 shadow-md disabled:opacity-50" disabled={!message.trim()}>

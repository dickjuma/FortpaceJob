...
const NOTIFICATIONS = [
  ...
  { id: 2, type: 'Messages', title: 'New Message from Sarah', message: 'Great work! Let\'s proceed with the next milestone.', time: '1 hour ago', isRead: false, icon: MessageSquare, color: 'text-brand-500', bg: 'bg-brand-50 dark:bg-brand-500/10' },
  { id: 3, type: 'Contracts', title: 'Contract Started', message: 'You have a new active contract: React Native E-Commerce App.', time: 'Yesterday', isRead: true, icon: FileText, color: 'text-brand-500', bg: 'bg-brand-50 dark:bg-brand-500/10' },
  ...
  { id: 6, type: 'Jobs', title: 'Job Match', message: 'A new job matching your skills was just posted: Senior Next.js Developer.', time: 'May 17', isRead: true, icon: Briefcase, color: 'text-brand-500', bg: 'bg-brand-50 dark:bg-brand-500/10' },
];
            ...
            {filteredNotifications.map((notif, index) => (
              ...
              >
                ...
                <div className="relative shrink-0">
                  ...
                  {!notif.isRead && (
                    <div className="absolute top-0 right-0 w-3 h-3 bg-brand-500 rounded-full border-2 border-white dark:border-zinc-900"></div>
                  )}
                </div>

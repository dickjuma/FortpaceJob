    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div>
            <p className="text-brand-200 text-sm">Escrow Balance</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <ArrowDownRight className="text-brand-600" size={24} />
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3 bg-brand-600 text-white rounded-lg font-semibold hover:bg-brand-700 disabled:opacity-50"
            >
              ...
              <div key={i} className="flex items-center justify-between py-3 border-b">
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    i % 2 === 0 ? "bg-green-100" : "bg-brand-100"
                  }`}>
                    {i % 2 === 0 ? (
                      <ArrowUpRight className="text-green-600" size={20} />
                    ) : (
                      <ArrowDownRight className="text-brand-600" size={20} />
                    )}
                  </div>
                  <div>

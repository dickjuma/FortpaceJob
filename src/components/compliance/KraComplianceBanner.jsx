        ...
        <div className="flex-1 min-w-0">
          ...
          {!compact && (
            <div className="mt-3 h-2 bg-white/80 rounded-full overflow-hidden border border-zinc-200">
              <div
                className={`h-full transition-all ${taxLocked ? 'bg-red-500' : 'bg-[#14a800]'}`}
          ...
          {!compliance.kraPinVerified && (
            <div className="mt-4 flex flex-col sm:flex-row gap-2">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-[#14a800] text-white text-sm font-bold rounded-lg disabled:opacity-50"
              >
                {updateKra.isPending ? (

            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-6">
                <div className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm">
                  ...
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span className="font-bold text-[#14a800]">40%</span>
                  </div>
                  <div className="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-2">
                    <div className="bg-[#14a800] h-2 rounded-full" style={{ width: '40%' }}></div>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-[#14a800]/5 dark:bg-[#14a800]/20 rounded-lg border border-[#14a800]/20 dark:border-[#14a800]/20/50">
                    <ShieldCheck className="w-6 h-6 text-[#14a800]" />
                    <div>

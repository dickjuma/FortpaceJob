      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center">
            <Scale className="w-6 h-6 mr-3 text-[#14a800]" /> Dispute Center
          </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 space-y-4">
          ...
          {disputes.map(dispute => (
            <div key={dispute.id} className="bg-white dark:bg-gray-900 border border-[#14a800]/20 dark:border-[#14a800]/20 rounded-xl p-5 shadow-sm cursor-pointer relative overflow-hidden">
              <div className="absolute left-0 top-0 w-1 h-full bg-[#14a800]"></div>
              <div className="flex justify-between items-start mb-2">
                <span className="text-xs font-bold text-[#14a800] dark:text-[#14a800] uppercase tracking-wider">{dispute.id}</span>
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm flex flex-col h-[600px]">
            ...
            <div className="flex-1 p-6 overflow-y-auto bg-surface dark:bg-gray-950 space-y-6">
              ...
              <div className="flex gap-4 flex-row-reverse">
                <div className="w-10 h-10 rounded-full bg-[#14a800]/10 text-[#14a800] flex items-center justify-center shrink-0 text-sm font-bold">
                  SJ
                </div>
                <div className="bg-[#14a800]/5 dark:bg-[#14a800]/20 p-4 rounded-2xl rounded-tr-none shadow-sm border border-[#14a800]/20 dark:border-[#14a800]/20/50 text-sm">
              ...
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-full bg-[#14a800]/10 text-[#14a800] flex items-center justify-center shrink-0">
                  <Scale className="w-5 h-5" />
                </div>
                <div className="bg-[#14a800]/5 dark:bg-[#14a800]/20 p-4 rounded-2xl rounded-tl-none shadow-sm border border-[#14a800]/50 dark:border-[#14a800]/50/50 text-sm w-full">
                  <p className="font-bold mb-1 text-[#14a800] dark:text-[#14a800]">Admin Response</p>
            ...
            <div className="p-4 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
              <div className="flex items-center gap-4">
                ...
                <input 
                  ...
                  className="flex-1 bg-gray-100 dark:bg-gray-800 border-none rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#14a800] outline-none"
                />
                <button className="p-3 bg-[#14a800] hover:bg-[#118a00] text-white rounded-xl transition-colors">

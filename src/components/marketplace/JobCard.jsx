...
export default function JobCard({ job }) {
  ...
  return (
    <article className="group flex flex-col h-full bg-white border border-zinc-200 rounded-xl p-5 hover:border-[#14a800]/40 hover:shadow-sm transition-all">
      <div className="flex items-center justify-between gap-2 mb-3">
        <span className="text-[10px] font-bold uppercase tracking-wide text-[#14a800]">
      ...
      <h3 className="font-semibold text-zinc-900 text-base leading-snug line-clamp-2 group-hover:text-[#118a00] mb-2">
        {job.title}
      </h3>
      ...
      <Link
        ...
        className="mt-4 block text-center py-2.5 rounded-lg bg-zinc-900 text-white text-sm font-bold group-hover:bg-[#14a800] transition-colors"
      >
        View job
      </Link>
    </article>

      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
        ...
        >
          ...
          <div className="p-6 space-y-6">
            <div>
              ...
              <input 
                ...
                className="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-950 text-gray-900 dark:text-white focus:ring-2 focus:ring-[#4C1D95] outline-none"
              />
            </div>
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-950 text-gray-900 dark:text-white focus:ring-2 focus:ring-[#4C1D95] outline-none resize-none"
              />
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    type="number" 
                    placeholder="5000"
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-950 text-gray-900 dark:text-white focus:ring-2 focus:ring-[#4C1D95] outline-none"
                  />
                </div>
              </div>
              <div>
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-800">
              <button className="flex items-center text-sm font-medium text-[#4C1D95] dark:text-[#4C1D95] hover:text-[#4C1D95]">
          ...
          <div className="p-6 bg-surface dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-800 flex justify-end gap-3">
            ...
            <button className="px-5 py-2.5 bg-[#4C1D95] hover:bg-[#22C55E] text-white rounded-xl text-sm font-medium transition-colors flex items-center shadow-lg shadow-[#4C1D95]/25/25">

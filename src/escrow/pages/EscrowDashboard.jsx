    ...
    <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden">
        <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center">
          ...
          <button className="text-sm font-medium text-[#4C1D95] dark:text-[#4C1D95] hover:text-[#4C1D95]">View All</button>
        </div>
          ...
          <table className="w-full text-left text-sm whitespace-nowrap">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
              <tr>
                ...
                <td className="px-6 py-4">
                  <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-[#4C1D95]/5 text-[#4C1D95] dark:bg-[#4C1D95]/30 dark:text-[#4C1D95]">

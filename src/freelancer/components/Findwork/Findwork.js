      ...
      <div className="grid gap-4 xl:grid-cols-3">
        {focusCards.map((card) => (
          <Link
            key={card.title}
            to={card.to}
            className={`${skin.card} ${skin.border} rounded-[28px] border p-5 shadow-[0_18px_45px_rgba(33,24,21,0.05)] transition hover:-tranzinc-y-0.5 hover:shadow-[0_24px_55px_rgba(33,24,21,0.08)]`}
          >

...
const Benefit = ({ icon: Icon, title, desc }) => (
  <div className="flex gap-4 p-4 rounded-lg bg-white border border-[#E7E1DE] hover:border-[#22C55E] hover:shadow-sm transition-all duration-200">
    <div className="w-10 h-10 rounded-lg bg-[#FDECE7] flex items-center justify-center text-[#22C55E] shrink-0">
      <Icon size={20} />
    </div>
    <div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-[#FDECE7] rounded-lg">
              <Megaphone size={20} className="text-[#22C55E]" />
            </div>
            <div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#F8F4F1] p-5 rounded-lg border border-[#E7E1DE]">
              ...
              <input 
                ...
                className="w-full h-2 bg-[#EFE7E2] rounded-lg appearance-none cursor-pointer accent-[#22C55E] mb-2"
              />
            ...
            {/* CTA Button */}
            <div className="pt-4">
              <button className="w-full bg-[#22C55E] hover:bg-[#B53A27] text-white px-6 py-3 rounded-lg font-medium shadow-sm hover:shadow transition-all flex items-center justify-center gap-2">
                Start Campaign
            ...
            <div className="bg-[#F8F4F1] p-5 rounded-lg border border-[#E7E1DE]">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 bg-white rounded-lg border border-[#E7E1DE]">
                  <div className="text-2xl font-semibold text-[#22C55E] mb-1">+240%</div>
            ...
            <div className="border border-[#E7E1DE] rounded-lg overflow-hidden">
              <div className="bg-[#FDECE7] px-4 py-2 border-b border-[#E7E1DE]">
                <div className="flex items-center gap-2">
                  <div className="px-2 py-1 bg-[#22C55E] text-white text-xs font-medium rounded">
                    PROMOTED
                  </div>
      ...
      <div className="p-6 border-t border-[#E7E1DE] bg-[#F8F4F1]">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <button className="px-4 py-2 text-[#22C55E] hover:text-[#B53A27] font-medium">
              Learn More
            </button>
            <button className="px-6 py-2 bg-[#22C55E] hover:bg-[#B53A27] text-white rounded-lg font-medium">
              Start Campaign
            </button>
          </div>
        </div>

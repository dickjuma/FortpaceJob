      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
            <CalendarIcon className="w-8 h-8 text-[#2bb75c]" />
        ...
        <button 
          onClick={handleSave}
          disabled={isSaving}
          className="flex items-center justify-center gap-2 bg-[#2bb75c] hover:bg-[#1d8d38] disabled:opacity-70 text-white px-6 py-2.5 rounded-xl font-medium transition-colors shadow-sm shrink-0"
        >
          {isSaving ? (
          ...
          >
            ...
            <div className="space-y-3">
              {[
                ...
                { id: 'vacation', label: 'On Vacation Mode', icon: Plane, color: 'text-[#2bb75c]', bg: 'bg-[#2bb75c]/5 dark:bg-[#2bb75c]/20', border: 'border-[#2bb75c]/20 dark:border-[#2bb75c]/20' }
              ].map(s => (
                <label 
                  key={s.id} 
            ...
            <div className="space-y-4">
              <div>
                ...
                <select 
                  ...
                  className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-surface dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-[#2bb75c] outline-none"
                >
              ...
              <div>
                ...
                <select className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-surface dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-[#2bb75c] outline-none">
          ...
          >
            ...
            <div className="flex-1 overflow-x-auto p-6">
              <div className="min-w-[700px]">
                ...
                <div className="space-y-2 relative">
                  {status === 'vacation' && (
                    <div className="absolute inset-0 z-10 bg-white/60 dark:bg-gray-900/60 backdrop-blur-[1px] flex items-center justify-center rounded-xl border border-[#2bb75c]/20 dark:border-[#2bb75c]/20/30">
                      <div className="bg-white dark:bg-gray-800 px-6 py-4 rounded-2xl shadow-xl flex items-center gap-4">
                        <div className="p-3 bg-[#2bb75c]/5 dark:bg-[#2bb75c]/20 text-[#2bb75c] rounded-full">
                        ...
                        return (
                          <button
                            ...
                            className={`h-10 rounded-md border text-xs font-medium transition-all ${
                              isSelected 
                                ? 'bg-[#2bb75c]/10 border-[#2bb75c]/20 text-[#2bb75c] dark:bg-[#2bb75c]/40 dark:border-[#2bb75c]/20 dark:text-[#2bb75c] hover:bg-[#2bb75c] dark:hover:bg-[#2bb75c]/60' 
            ...
            <div className="p-4 bg-surface dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500 dark:text-gray-400 flex items-center justify-between">
              <div className="flex gap-4">
                <span className="flex items-center gap-1.5"><div className="w-3 h-3 rounded bg-[#2bb75c]/10 border border-[#2bb75c]/20 dark:bg-[#2bb75c]/40 dark:border-[#2bb75c]/20" /> Available</span>

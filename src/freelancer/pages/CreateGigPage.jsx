...
export default function CreateGigPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="mb-8">
        <Link to="/freelancer/gigs" className="text-sm font-medium text-[#2bb75c] hover:text-[#2bb75c] mb-4 inline-block">
          ← Back to My Gigs
        </Link>
      ...
      <div className="flex mb-8 space-x-2">
        {['Overview', 'Pricing', 'Gallery', 'Publish'].map((label, idx) => (
          <div key={idx} className="flex-1">
            <div className={`h-2 w-full rounded-full mb-2 ${step > idx ? 'bg-[#2bb75c]' : 'bg-gray-200 dark:bg-gray-800'}`}></div>
            <p className={`text-xs font-bold text-center ${step > idx ? 'text-[#2bb75c]' : 'text-gray-400'}`}>{label}</p>
          </div>
        ))}
      </div>
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div>
              ...
              <div className="flex items-center text-xl font-bold text-gray-900 dark:text-white mb-2">
                ...
                <input 
                  ...
                  className="w-full border-b-2 border-gray-200 dark:border-gray-700 bg-transparent py-2 focus:border-[#2bb75c]/20 focus:outline-none focus:ring-0 placeholder-gray-300 dark:placeholder-gray-700"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select className="w-full border border-gray-300 dark:border-gray-700 bg-surface dark:bg-gray-800 text-gray-900 dark:text-white rounded-xl px-4 py-3 focus:ring-[#2bb75c] focus:border-[#2bb75c]/20">

    ...
    <div className="min-h-screen bg-black font-sans text-white overflow-hidden selection:bg-white/30">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 py-4 bg-black/50 backdrop-blur-md border-b border-white/10">
        <div className="flex items-center gap-2">
          <span className="text-xl font-extrabold tracking-tight">Forte<span className="text-brand-500">PRO</span></span>
        </div>
      ...
      <div className="relative pt-32 pb-20 px-4 sm:px-6 flex flex-col items-center justify-center text-center min-h-[70vh]">
        ...
        {/* Glow Effects */}
        <div className="absolute top-1/2 left-1/2 -tranzinc-x-1/2 -tranzinc-y-1/2 w-[600px] h-[600px] bg-brand-500/20 rounded-full blur-[120px] pointer-events-none" />
        ...
        >
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-brand-400 via-violet-400 to-sky-400">
            Unrivaled quality.
          </span>
        </motion.h1>
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-brand-400 font-bold">{gig.seller.title}</p>
                    </div>
                  </div>

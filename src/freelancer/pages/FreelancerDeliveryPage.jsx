          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h1 className="text-2xl font-black text-zinc-900 dark:text-white flex items-center gap-3">
                <Package className="w-6 h-6 text-[#2bb75c]" /> Submit Final Delivery
              </h1>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 space-y-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <textarea 
                  ...
                  className="w-full p-4 bg-surface dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm font-medium outline-none focus:border-[#2bb75c]/20 resize-y text-zinc-900 dark:text-white transition-colors"
                ></textarea>
              </div>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-zinc-300 dark:border-zinc-700 rounded-2xl p-8 flex flex-col items-center justify-center cursor-pointer hover:bg-surface dark:hover:bg-zinc-800/50 transition-colors group">
                  <div className="w-12 h-12 bg-white dark:bg-surface-dark shadow-sm rounded-full flex items-center justify-center mb-3 group-hover:-tranzinc-y-1 transition-transform">
                    <UploadCloud className="w-6 h-6 text-[#2bb75c]" />
                  </div>
                  <p className="text-sm font-bold text-zinc-900 dark:text-white mb-1">Drag & drop files or <span className="text-[#2bb75c]">browse</span></p>
              ...
              <div>
                ...
                <div className="flex relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-surface dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm font-medium outline-none focus:border-[#2bb75c]/20 transition-colors text-zinc-900 dark:text-white"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 shadow-sm">
            ...
            <div className="space-y-4">
              <label className={cn("flex items-start gap-4 p-4 border rounded-xl cursor-pointer transition-colors", checklist.source ? "border-[#2bb75c]/20 bg-[#2bb75c]/5 dark:bg-[#2bb75c]/10" : "border-zinc-200 dark:border-zinc-700 hover:bg-surface dark:hover:bg-zinc-800")}>
                <input type="checkbox" className="w-5 h-5 mt-0.5 rounded border-zinc-300 text-[#2bb75c] focus:ring-[#2bb75c]" checked={checklist.source} onChange={() => setChecklist(p => ({...p, source: !p.source}))} />
                <div>
              ...
              <label className={cn("flex items-start gap-4 p-4 border rounded-xl cursor-pointer transition-colors", checklist.assets ? "border-[#2bb75c]/20 bg-[#2bb75c]/5 dark:bg-[#2bb75c]/10" : "border-zinc-200 dark:border-zinc-700 hover:bg-surface dark:hover:bg-zinc-800")}>
                <input type="checkbox" className="w-5 h-5 mt-0.5 rounded border-zinc-300 text-[#2bb75c] focus:ring-[#2bb75c]" checked={checklist.assets} onChange={() => setChecklist(p => ({...p, assets: !p.assets}))} />
                <div>
              ...
              <label className={cn("flex items-start gap-4 p-4 border rounded-xl cursor-pointer transition-colors", checklist.instructions ? "border-[#2bb75c]/20 bg-[#2bb75c]/5 dark:bg-[#2bb75c]/10" : "border-zinc-200 dark:border-zinc-700 hover:bg-surface dark:hover:bg-zinc-800")}>
                <input type="checkbox" className="w-5 h-5 mt-0.5 rounded border-zinc-300 text-[#2bb75c] focus:ring-[#2bb75c]" checked={checklist.instructions} onChange={() => setChecklist(p => ({...p, instructions: !p.instructions}))} />
                <div>
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="px-8 py-3 bg-[#2bb75c] hover:bg-[#1d8d38] text-white font-bold rounded-xl shadow-lg shadow-[#2bb75c]/25/20 transition-all flex items-center gap-2">
        ...
        <div className="w-full lg:w-80 shrink-0 space-y-6">
          ...
          <div className="bg-surface-dark dark:bg-surface-dark text-white rounded-3xl p-6 border border-zinc-800 shadow-xl">
            <h3 className="font-bold flex items-center gap-2 mb-4"><Info className="w-5 h-5 text-[#2bb75c]" /> Delivery Process</h3>
            ...
            <div className="space-y-6 relative before:absolute before:inset-0 before:ml-[11px] before:-tranzinc-x-px md:before:mx-auto md:before:tranzinc-x-0 before:h-full before:w-0.5 before:bg-zinc-100 dark:before:bg-zinc-800">
              ...
              {HISTORY.map((item, i) => (
                <div key={item.id} className="relative flex items-start gap-4">
                  <div className="w-6 h-6 rounded-full bg-white dark:bg-surface-dark border-2 border-[#2bb75c]/20 flex items-center justify-center shrink-0 z-10 mt-1">
                    <CheckCircle2 className="w-3 h-3 text-[#2bb75c]" />
                  </div>
                  <div>

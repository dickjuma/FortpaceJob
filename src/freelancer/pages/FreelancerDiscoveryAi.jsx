...
import { useDiscoveryAiChat } from '../services/freelancerHooks';
...
const FreelancerDiscoveryAi = () => {
  ...
  const chatMutation = useDiscoveryAiChat();
    ...
    chatMutation.mutate({ message: userMsg }, {
      onSuccess: (res) => {
        setMessages(prev => [...prev, { 
          type: 'bot', 
          text: res?.data?.reply || `I found 3 exceptional React developers for your dashboard project. They are all Top Rated and available to start immediately.`,

    ...
    <div className="min-h-screen bg-surface dark:bg-surface-dark font-sans pb-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-extrabold text-zinc-900 dark:text-white tracking-tight mb-2 flex items-center gap-3">
              <TrendingUp className="w-8 h-8 text-brand-500" /> Performance Insights
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { label: 'Profile Views', value: '3,240', trend: '+12%', icon: Eye, color: 'text-brand-500', bg: 'bg-brand-50 dark:bg-brand-500/10' },
            ...
            { label: 'Client Satisfaction', value: '4.9/5', trend: 'Top 5%', icon: Star, color: 'text-brand-500', bg: 'bg-brand-50 dark:bg-brand-500/10' }
          ].map(kpi => (
            <div key={kpi.label} className="bg-white dark:bg-surface-dark rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm flex flex-col justify-between group hover:border-brand-300 transition-colors cursor-default">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            ...
            {/* AI Insights */}
            <div className="bg-gradient-to-br from-brand-900 to-zinc-900 rounded-3xl p-8 shadow-lg text-white relative overflow-hidden">
              <div className="absolute top-0 right-0 p-4 opacity-10">
                <Sparkles className="w-32 h-32" />
              </div>
              <div className="relative z-10">
                <h2 className="text-xl font-bold mb-6 flex items-center gap-2">
                  <Sparkles className="w-5 h-5 text-brand-400" /> AI Recommendations
                </h2>
                
                <div className="space-y-4">
                  <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-4">
                    <p className="text-xs font-bold text-brand-300 uppercase tracking-wider mb-2">Pricing Strategy</p>

          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            >
              ...
              <div className="p-6 md:p-8 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    ...
                    <input type="text" placeholder="e.g. Fintech Mobile App UI" className="w-full px-4 py-3 bg-surface dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm font-medium outline-none focus:border-brand-500" />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="month" className="w-full px-4 py-3 bg-surface dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm font-medium outline-none focus:border-brand-500 text-zinc-500" />
                  </div>
                  <div className="md:col-span-2">
                    <label className="block text-sm font-bold text-zinc-900 dark:text-white mb-2">Case Study / Description</label>
                    <div className="border border-zinc-200 dark:border-zinc-700 rounded-xl overflow-hidden focus-within:border-brand-500 transition-colors">
              ...
              <div className="sticky bottom-0 bg-white/90 dark:bg-surface-dark/90 backdrop-blur-md border-t border-zinc-200 dark:border-zinc-800 p-6 flex justify-end gap-4 z-20 rounded-b-3xl">
                ...
                <button className="px-8 py-3 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-xl shadow-sm transition-all">Publish Project</button>
              </div>

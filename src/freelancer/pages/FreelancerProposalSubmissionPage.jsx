        ...
        <div className="flex-1 space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row gap-6 justify-between items-start sm:items-center">
                ...
                <div className="relative w-full sm:w-48 shrink-0">
                  ...
                  <input type="number" defaultValue={4500} className="w-full pl-10 pr-4 py-3 bg-surface dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl font-bold text-zinc-900 dark:text-white outline-none focus:border-brand-500 text-right" />
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-zinc-100 dark:border-zinc-800">
                ...
                <select className="w-full sm:w-1/2 px-4 py-3 bg-surface dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm font-medium outline-none focus:border-brand-500">
          ...
          <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              ...
              <button className="flex items-center gap-2 text-sm font-bold text-brand-600 dark:text-brand-400 hover:bg-brand-50 dark:hover:bg-brand-500/10 px-3 py-1.5 rounded-lg transition-colors">
            ...
            <div className="mb-6">
              <textarea 
                ...
                className="w-full p-4 bg-surface dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm font-medium outline-none focus:border-brand-500 resize-y text-zinc-900 dark:text-white"
              ></textarea>
            </div>
            ...
            <div className="border-t border-zinc-100 dark:border-zinc-800 pt-6">
              ...
              <div className="border-2 border-dashed border-zinc-300 dark:border-zinc-700 rounded-2xl p-8 flex flex-col items-center justify-center cursor-pointer hover:bg-surface dark:hover:bg-zinc-800/50 transition-colors">
                ...
                <p className="text-sm font-bold text-brand-600 mb-1">Upload files or drag and drop</p>
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="px-8 py-3 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-xl shadow-lg shadow-brand-600/20 transition-colors">
              Submit Proposal
            </button>
          </div>

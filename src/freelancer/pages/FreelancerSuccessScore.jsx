...
const FreelancerSuccessScore = () => {
  ...
  const score = scoreData.score || 95;
  const strokeDashoffset = 552.9 - (552.9 * score) / 100;
  return (
    <>
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 mb-16">
            <div className="w-48 h-48 rounded-full border-8 border-zinc-100 flex items-center justify-center relative shrink-0">
              ...
              <svg className="absolute inset-0 w-full h-full transform -rotate-90">
                ...
                <circle cx="96" cy="96" r="88" stroke="currentColor" strokeWidth="8" fill="none" strokeDasharray="552.9" strokeDashoffset={strokeDashoffset} className="text-success transition-all duration-1000 ease-in-out" />
              </svg>
              <div className="text-center">
                <div className="text-5xl font-black text-zinc-900">{score}%</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white border border-zinc-200 rounded-3xl p-8 shadow-sm">
              <h3 className="text-xl font-bold text-zinc-900 mb-6 flex items-center gap-2">
                <TrendingUp className="w-5 h-5 text-[#4C1D95]" /> Score Breakdown
              </h3>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between text-sm font-bold text-zinc-700 mb-2">
                    ...
                    <span className="text-[#4C1D95]">Great</span>
                  </div>
                  <div className="h-2 bg-zinc-100 rounded-full overflow-hidden">
                    <div className="w-[85%] h-full bg-[#4C1D95] rounded-full"></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-sm font-bold text-zinc-700 mb-2">

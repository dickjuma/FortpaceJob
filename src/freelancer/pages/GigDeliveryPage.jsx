        ...
        <form onSubmit={handleDeliver}>
          ...
          <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-xl overflow-hidden mb-8">
            ...
            <div className="p-6 sm:p-8 space-y-8">
              ...
              <div>
                ...
                <div className="w-full border-2 border-dashed border-zinc-300 dark:border-zinc-700 bg-surface dark:bg-zinc-800/30 rounded-2xl p-8 flex flex-col items-center justify-center cursor-pointer hover:border-brand-500 transition-all text-center group">
                  <UploadCloud className="w-10 h-10 text-zinc-300 dark:text-zinc-600 mb-3 group-hover:text-brand-500 transition-colors" />
              ...
              <div className="pt-8 border-t border-zinc-100 dark:border-zinc-800">
                <div className="flex items-start gap-4 p-4 bg-brand-50 dark:bg-brand-500/5 border border-brand-100 dark:border-brand-500/20 rounded-2xl cursor-pointer" onClick={() => setPortfolioSample(!portfolioSample)}>
                  <div className={cn(
                    "w-6 h-6 rounded flex items-center justify-center shrink-0 mt-0.5 transition-colors border-2",
                    portfolioSample ? "bg-brand-500 border-brand-500" : "border-brand-200 dark:border-brand-800 bg-white dark:bg-surface-dark"
                  )}>
                    {portfolioSample && <CheckCircle2 className="w-4 h-4 text-white" />}
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-brand-900 dark:text-brand-100 mb-1 flex items-center gap-2">
                      <ImageIcon className="w-4 h-4" /> Add a sample to your Gig Gallery
                    </h4>
                    <p className="text-xs font-medium text-brand-700/70 dark:text-brand-300/70 leading-relaxed">
                    ...
                    <AnimatePresence>
                      {portfolioSample && (
                        <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="mt-4 pt-4 border-t border-brand-200/50 dark:border-brand-800/50">
                           <div className="w-full h-24 border-2 border-dashed border-brand-200 dark:border-brand-800 bg-white/50 dark:bg-surface-dark/50 rounded-xl flex items-center justify-center text-brand-600 dark:text-brand-400 text-xs font-bold hover:border-brand-400 transition-colors">
          ...
          <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-sm p-6 sm:p-8">
            ...
            <button
              ...
              className="w-full py-4 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isDelivering ? (

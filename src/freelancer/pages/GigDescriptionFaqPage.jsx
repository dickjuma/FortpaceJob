      ...
      <div className="flex-1 w-full space-y-8">
        ...
        <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 shadow-sm">
          <div className="flex justify-between items-start mb-6">
            ...
            <button className="flex items-center gap-1.5 px-3 py-1.5 bg-brand-50 dark:bg-brand-500/10 text-brand-600 dark:text-brand-400 rounded-xl text-xs font-bold hover:bg-brand-100 transition-colors shrink-0">
          ...
          <textarea
            ...
            className="w-full p-4 border-x border-b border-zinc-200 dark:border-zinc-700 rounded-b-xl bg-white dark:bg-surface-dark text-sm font-medium text-zinc-900 dark:text-white resize-none outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-all"
          />

          <div className="mt-4 flex items-start gap-2 p-3 bg-brand-50 dark:bg-brand-900/10 border border-brand-100 dark:border-brand-900/30 rounded-xl">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 bg-white dark:bg-surface-dark border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm font-bold outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500"
                    />
                  </div>
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full p-3 bg-white dark:bg-surface-dark border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm font-medium outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 resize-none"
                    />
                  </div>
                  <div className="flex justify-end gap-2 pt-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-brand-600 disabled:bg-zinc-300 text-white text-sm font-bold rounded-xl transition-colors"
                    >
                      Add
                    </button>
                  </div>
          ...
          <div className="space-y-3">
                ...
                return (
                  <motion.div
                    ...
                    className={cn(
                      ...
                      isExpanded ? "border-brand-200 dark:border-brand-500/30 bg-white dark:bg-surface-dark" : "border-zinc-200 dark:border-zinc-800 bg-white dark:bg-surface-dark"
                    )}
                  >
                    <div
                      ...
                      className={cn(
                        ...
                        isExpanded ? "bg-brand-50 dark:bg-brand-500/5" : "hover:bg-surface dark:hover:bg-zinc-800/50"
                      )}
                    >
                      <h4 className="font-bold text-sm text-zinc-900 dark:text-white pr-4">{faq.question}</h4>
                      {isExpanded ? <ChevronUp className="w-5 h-5 text-brand-500 shrink-0" /> : <ChevronDown className="w-5 h-5 text-zinc-400 shrink-0" />}
                    </div>
            ...
            {faqs.length === 0 && !isFaqFormOpen && (
              <div className="text-center py-8 border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-2xl">
                ...
                <button onClick={() => setIsFaqFormOpen(true)} className="text-sm font-bold text-brand-600">Add your first FAQ</button>
              </div>
            )}
          </div>
        </div>
      ...
      <div className="w-full lg:w-80 shrink-0 space-y-6">
        ...
        <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-bold text-zinc-900 dark:text-white flex items-center gap-2">
              <FileText className="w-4 h-4 text-brand-500" /> SEO Readability
            </h3>
            <span className={cn(
        ...
        <div className="bg-gradient-to-br from-brand-600 to-violet-600 rounded-3xl p-6 text-white shadow-xl shadow-brand-500/20">
          <div className="flex items-center gap-2 mb-4">
            <Wand2 className="w-5 h-5 text-brand-200" />
            <h3 className="font-bold text-brand-50">Conversion Tips</h3>
          </div>

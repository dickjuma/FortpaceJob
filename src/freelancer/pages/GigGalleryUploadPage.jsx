      ...
      <div className="flex-1 w-full space-y-8">
          ...
          <div className="flex justify-between items-end mb-6">
            <div>
              <h3 className="text-lg font-bold text-zinc-900 dark:text-white flex items-center gap-2">
                <ImageIcon className="w-5 h-5 text-[#2bb75c]" /> Images (up to 3)
              </h3>
            ...
            {images.length < 3 && (
              <div 
                ...
                className={cn(
                  ...
                  isDragging ? "border-[#2bb75c]/20 bg-[#2bb75c]/5 dark:bg-[#2bb75c]/10" : "border-zinc-300 dark:border-zinc-700 bg-surface dark:bg-zinc-800 hover:border-[#2bb75c]/20 dark:hover:border-[#2bb75c]/20"
                )}
              >
                <div className="absolute inset-0 bg-[#2bb75c]/0 group-hover:bg-[#2bb75c]/5 transition-colors" />
                <UploadCloud className={cn("w-8 h-8 mb-3 transition-colors", isDragging ? "text-[#2bb75c]" : "text-zinc-400 group-hover:text-[#2bb75c]")} />
              ...
              {images.map(img => (
                <motion.div 
                  ...
                  className={cn(
                    ...
                    img.isCover ? "border-[#2bb75c]/20 shadow-md" : "border-zinc-200 dark:border-zinc-700"
                  )}
                >
                  {img.progress < 100 ? (
                    ...
                    <div className="absolute inset-0 bg-zinc-100 dark:bg-zinc-800 flex flex-col items-center justify-center p-4">
                      <div className="w-full h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full overflow-hidden mb-2">
                        <motion.div className="h-full bg-[#2bb75c] rounded-full" animate={{ width: `${img.progress}%` }} />
                      </div>
                    ...
                    <>
                      ...
                      {/* Cover Badge */}
                      {img.isCover && (
                        <div className="absolute top-3 left-3 bg-[#2bb75c] text-white text-[10px] font-black uppercase tracking-wider px-2 py-1 rounded-md shadow-sm flex items-center gap-1">
        ...
        <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 shadow-sm">
           <div className="flex justify-between items-end mb-6">
            <div>
              <h3 className="text-lg font-bold text-zinc-900 dark:text-white flex items-center gap-2">
                <Video className="w-5 h-5 text-#2bb75c]" /> Video (1 only)
              </h3>
          ...
          {videos.length === 0 ? (
            <div className="w-full h-40 rounded-2xl border-2 border-dashed border-zinc-300 dark:border-zinc-700 bg-surface dark:bg-zinc-800 hover:border-violet-400 dark:hover:border-violet-600 flex flex-col items-center justify-center p-4 text-center cursor-pointer transition-colors group">
              <PlayCircle className="w-10 h-10 text-zinc-300 dark:text-zinc-600 mb-3 group-hover:text-#2bb75c] transition-colors" />
      ...
      <div className="w-full lg:w-80 shrink-0 space-y-6">
        ...
        <div className="bg-[#2bb75c]/5 dark:bg-[#2bb75c]/10 rounded-3xl border border-[#2bb75c]/20 dark:border-[#2bb75c]/20/30 p-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-bold text-[#2bb75c] dark:text-[#2bb75c]">Media Policy</h3>
          </div>
          <p className="text-xs text-[#2bb75c] dark:text-[#2bb75c] leading-relaxed mb-4">
            To ensure the quality of our marketplace, all uploaded media must comply with Forte's Terms of Service.
          </p>
          <button className="text-xs font-bold text-[#2bb75c] dark:text-[#2bb75c] hover:underline">Read full guidelines &rarr;</button>
        </div>

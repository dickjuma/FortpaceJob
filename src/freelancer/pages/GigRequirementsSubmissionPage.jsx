  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen bg-surface dark:bg-surface-dark flex flex-col items-center justify-center p-4 font-sans">
        ...
        >
          <div className="w-20 h-20 bg-brand-100 dark:bg-brand-500/20 text-brand-600 dark:text-brand-400 rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <button className="w-full py-3.5 bg-brand-600 text-white font-bold rounded-xl shadow-sm hover:bg-brand-700 transition-colors">
            Go to Order Track
          </button>
        </motion.div>
      </div>
            ...
            <div className="p-6 sm:p-10 space-y-10">
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-8 rounded-full bg-brand-100 dark:bg-brand-500/20 text-brand-600 dark:text-brand-400 flex items-center justify-center font-bold text-sm shrink-0">1</div>
                ...
                <div className="pl-11">
                  <textarea 
                    ...
                    className="w-full min-h-[150px] bg-surface dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700 rounded-xl p-4 text-sm font-medium text-zinc-900 dark:text-white outline-none focus:ring-2 focus:ring-brand-500 transition-all resize-none placeholder:text-zinc-400"
                  />
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-8 rounded-full bg-brand-100 dark:bg-brand-500/20 text-brand-600 dark:text-brand-400 flex items-center justify-center font-bold text-sm shrink-0">2</div>
                  <label className="text-lg font-bold text-zinc-900 dark:text-white leading-snug">
                ...
                <div className="pl-11">
                  <input 
                    ...
                    className="w-full bg-surface dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700 rounded-xl p-4 text-sm font-medium text-zinc-900 dark:text-white outline-none focus:ring-2 focus:ring-brand-500 transition-all placeholder:text-zinc-400"
                  />
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-8 rounded-full bg-brand-100 dark:bg-brand-500/20 text-brand-600 dark:text-brand-400 flex items-center justify-center font-bold text-sm shrink-0">3</div>
                  <label className="text-lg font-bold text-zinc-900 dark:text-white leading-snug">
                ...
                <div className="pl-11">
                  <div className="w-full border-2 border-dashed border-zinc-300 dark:border-zinc-700 bg-surface dark:bg-zinc-800/30 rounded-2xl p-8 flex flex-col items-center justify-center cursor-pointer hover:border-brand-500 hover:bg-brand-50 dark:hover:bg-brand-500/5 transition-all text-center">
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-8 rounded-full bg-brand-100 dark:bg-brand-500/20 text-brand-600 dark:text-brand-400 flex items-center justify-center font-bold text-sm shrink-0">4</div>
                  <label className="text-lg font-bold text-zinc-900 dark:text-white leading-snug">
                ...
                <div className="pl-11">
                  <div className="relative">
                    ...
                    <input 
                      ...
                      placeholder="https://..."
                      className="w-full bg-surface dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700 rounded-xl pl-11 pr-4 py-4 text-sm font-medium text-zinc-900 dark:text-white outline-none focus:ring-2 focus:ring-brand-500 transition-all placeholder:text-zinc-400"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="bg-surface dark:bg-surface-dark/50 border-t border-zinc-200 dark:border-zinc-800 p-6 sm:px-10 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                ...
                <button 
                  ...
                  className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-8 py-3 bg-brand-600 hover:bg-brand-700 text-white text-sm font-bold rounded-xl shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (

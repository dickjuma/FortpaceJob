          ...
          <div className="relative">
            <textarea
              ...
              className={cn(
                ...
                title.length > 80 ? "border-rose-300 focus:ring-rose-500" : "border-zinc-200 dark:border-zinc-700 focus:border-brand-500 focus:ring-brand-500"
              )}
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <select 
                ...
                className="w-full p-3 bg-surface dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm font-semibold text-zinc-900 dark:text-white outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500"
              >
            ...
            <div className="space-y-2">
              ...
              <select 
                ...
                disabled={!category}
                className="w-full p-3 bg-surface dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm font-semibold text-zinc-900 dark:text-white outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 shadow-sm">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="p-2 bg-surface dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700 rounded-xl flex flex-wrap gap-2 items-center focus-within:border-brand-500 focus-within:ring-1 focus-within:ring-brand-500 transition-all">
                <AnimatePresence>
                  {tags.map(tag => (
                    <motion.span 
                      key={tag}
                ...
                <div className="flex flex-wrap gap-2">
                  {SUGGESTED_KEYWORDS.map(tag => (
                    <button
                      ...
                      className="px-3 py-1 text-xs font-bold bg-brand-50 dark:bg-brand-500/10 text-brand-600 dark:text-brand-400 rounded-lg hover:bg-brand-100 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                    >
                      + {tag}
                    </button>
                  ))}
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-3 bg-surface dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm font-medium text-zinc-900 dark:text-white resize-none outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all"
              />

    ...
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-6 mb-8">
        ...
        <form onSubmit={addSkill} className="flex mb-4 relative">
          ...
          <input
            type="text"
            className="flex-1 block w-full pl-10 rounded-l-lg border-gray-300 dark:border-gray-700 bg-surface dark:bg-gray-800 focus:ring-[#2bb75c] focus:border-[#2bb75c]/20 sm:text-sm text-gray-900 dark:text-white"
            placeholder="E.g., Python, UI Design, AWS..."
            value={newSkill}
            onChange={(e) => setNewSkill(e.target.value)}
          />
          <button type="submit" className="px-4 py-2 bg-[#2bb75c] text-white rounded-r-lg hover:bg-[#1d8d38] font-medium text-sm border border-transparent">
            Add
          </button>
        </form>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-6">
        ...
        <ul className="space-y-4">
          ...
          <li className="flex items-center justify-center p-6 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-xl hover:border-[#2bb75c]/20 hover:bg-[#2bb75c]/5 dark:hover:bg-[#2bb75c]/10 transition-colors cursor-pointer group">
            <div className="text-center">
              <Award className="w-8 h-8 text-gray-400 group-hover:text-[#2bb75c] mx-auto mb-2" />

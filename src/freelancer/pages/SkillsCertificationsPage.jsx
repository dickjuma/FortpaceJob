    ...
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-6 mb-8">
        ...
        <form onSubmit={addSkill} className="flex mb-4 relative">
          ...
          <input
            type="text"
            className="flex-1 block w-full pl-10 rounded-l-lg border-gray-300 dark:border-gray-700 bg-surface dark:bg-gray-800 focus:ring-brand-500 focus:border-brand-500 sm:text-sm text-gray-900 dark:text-white"
            placeholder="E.g., Python, UI Design, AWS..."
            value={newSkill}
            onChange={(e) => setNewSkill(e.target.value)}
          />
          <button type="submit" className="px-4 py-2 bg-brand-600 text-white rounded-r-lg hover:bg-brand-700 font-medium text-sm border border-transparent">
            Add
          </button>
        </form>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <button className="text-sm font-medium text-brand-600 hover:text-brand-500 flex items-center">
        ...
        <ul className="space-y-4">
          ...
          <li className="flex items-center justify-center p-6 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-xl hover:border-brand-500 hover:bg-brand-50 dark:hover:bg-brand-900/10 transition-colors cursor-pointer group">
            <div className="text-center">
              <Award className="w-8 h-8 text-gray-400 group-hover:text-brand-500 mx-auto mb-2" />

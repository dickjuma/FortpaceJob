...
import JobCard from '../../../platform/components/marketplace/JobCard';
...
export default function OnlineWorkListings() {
  ...
  return (
    <>
      <div className="bg-[#4C1D95] text-white py-12 border-b border-[#22C55E]/30">
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#4C1D95]/20 text-[#4C1D95] text-xs font-bold tracking-wide mb-3 border border-[#4C1D95]/20/30">
            ...
            <form onSubmit={handleSearchSubmit} className="w-full md:w-[30rem] flex gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full bg-zinc-800 border border-zinc-700 rounded-xl pl-12 pr-4 py-3 focus:outline-none focus:border-[#4C1D95]/20 text-sm font-medium shadow-inner"
                />
              </div>
              <button type="submit" className="px-5 py-3 bg-[#4C1D95] hover:bg-[#22C55E] rounded-xl text-sm font-bold">
                Search
              </button>
            </form>
          </div>
          ...
          <div className="w-full lg:w-72 shrink-0 space-y-6">
            <div className="bg-white border border-zinc-200 rounded-2xl p-5 shadow-sm">
              <div className="flex justify-between items-center mb-4">
                ...
                <button type="button" onClick={resetFilters} className="text-xs font-bold text-[#4C1D95] hover:underline">
                  Clear All
                </button>
              </div>

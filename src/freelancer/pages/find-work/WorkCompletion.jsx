        ...
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          ...
          <div className="bg-white border border-zinc-200 rounded-3xl overflow-hidden shadow-sm mb-8">
            <div className="p-6 md:p-8 border-b border-zinc-100">
                ...
                deliveryFiles.map((file, index) => (
                  <div key={file.id || index} className="flex items-center justify-between p-4 bg-surface border border-zinc-200 rounded-xl mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#4C1D95]/10 text-[#4C1D95] rounded-lg flex items-center justify-center font-black text-xs">FILE</div>
                      <div>
              ...
              {deliveryNote && (
                <div className="bg-[#4C1D95]/5 border border-[#4C1D95]/20 rounded-xl p-4 mt-4">
                  <h4 className="font-bold text-[#4C1D95] text-sm mb-1">Message from {providerName}:</h4>
                  <p className="text-sm text-[#4C1D95]">{deliveryNote}</p>
                </div>
              )}
            </div>

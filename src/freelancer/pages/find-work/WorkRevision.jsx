...
import { validateRevisionFeedback } from '../../../platform/common/utils/validation';
          ...
          <form onSubmit={handleSubmit} className="bg-white border border-zinc-200 rounded-3xl p-6 md:p-8 shadow-sm">
            ...
            <div className="flex justify-end gap-4">
              ...
              <button
                ...
                className={`px-8 py-3 font-bold rounded-xl shadow-sm transition-all flex items-center gap-2 ${description && !submitting ? 'bg-[#4C1D95] hover:bg-[#22C55E] text-white' : 'bg-zinc-200 text-zinc-400 cursor-not-allowed'}`}
              >

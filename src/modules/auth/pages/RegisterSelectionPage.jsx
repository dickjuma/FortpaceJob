...
const RegisterSelectionPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface dark:bg-surface-dark text-zinc-900 dark:text-zinc-50 p-6 selection:bg-[#2bb75c]/30">
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#2bb75c]/10 rounded-full blur-[100px]" />
      ...
      <div className="w-full max-w-4xl relative z-10">
        <div className="text-center mb-12">
          <div className="flex justify-center items-center gap-2 mb-6">
            <div className="w-10 h-10 rounded-xl bg-[#2bb75c] flex items-center justify-center shadow-lg shadow-#2bb75c]/20">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <motion.div 
            ...
            className="group relative bg-white dark:bg-zinc-800 rounded-3xl p-8 border border-zinc-200 dark:border-zinc-700 shadow-sm hover:shadow-2xl hover:border-[#2bb75c]/20/50 transition-all duration-300 hover:-tranzinc-y-2 cursor-pointer overflow-hidden"
            onClick={() => navigate('/auth/register/client')}
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#2bb75c]/10 rounded-bl-full pointer-events-none transition-transform group-hover:scale-110" />
            
            <div className="w-16 h-16 rounded-2xl bg-[#2bb75c]/5 dark:bg-[#2bb75c]/10 flex items-center justify-center mb-8 border border-[#2bb75c]/20 dark:border-[#2bb75c]/20/20">
              <Briefcase className="w-8 h-8 text-[#2bb75c] dark:text-[#2bb75c]" />
            </div>
            ...
            <ul className="space-y-3 mb-8 text-zinc-600 dark:text-zinc-400">
              <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-[#2bb75c]" /> AI-matched elite talent</li>
              <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-[#2bb75c]" /> Secure escrow payments</li>
              <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-[#2bb75c]" /> Enterprise-grade contracts</li>
            </ul>

            <button className="w-full flex items-center justify-center gap-2 py-4 px-6 bg-surface-dark dark:bg-zinc-700 text-white rounded-xl font-semibold group-hover:bg-[#2bb75c] transition-colors">
        ...
        <p className="mt-12 text-center text-zinc-600 dark:text-zinc-400">
          Already have an account? <a href="/auth/login" className="font-semibold text-[#2bb75c] hover:underline">Log in</a>
        </p>
      </div>
    </div>
  );

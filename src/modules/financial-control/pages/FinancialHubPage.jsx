        ...
        <div className="p-6 bg-white dark:bg-surface-dark rounded-[32px] border border-zinc-200 dark:border-zinc-800 shadow-sm relative overflow-hidden group hover:border-emerald-500/30 transition-all">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <div className="p-2 bg-[#14a800]/5 text-[#14a800] rounded-xl">
                <Activity size={18} />
              </div>
      ...
      <div className="space-y-8">
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="group bg-white dark:bg-surface-dark p-8 rounded-[40px] border border-zinc-200 dark:border-zinc-800 shadow-sm hover:shadow-2xl hover:border-[#14a800]/20/50 transition-all cursor-pointer" onClick={() => window.location.pathname = '/admin/finance/transactions'}>
               <div className="w-16 h-16 bg-[#14a800]/10 text-[#14a800] rounded-[24px] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <Activity size={32} />
               </div>
               ...
               <div className="flex items-center text-[#14a800] font-bold text-sm">
            ...
            {/* Subscriptions */}
            <div className="group bg-white dark:bg-surface-dark p-8 rounded-[40px] border border-zinc-200 dark:border-zinc-800 shadow-sm hover:shadow-2xl hover:border-[#14a800]/50/50 transition-all cursor-pointer" onClick={() => window.location.pathname = '/admin/finance/subscriptions'}>
               <div className="w-16 h-16 bg-[#14a800]/10 text-[#14a800] rounded-[24px] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <CreditCard size={32} />
               </div>
          ...
          <div className="flex gap-2">
            <div className="relative">
              ...
              <input 
                ...
                className="pl-9 pr-4 py-1.5 bg-white dark:bg-surface-dark border border-zinc-200 dark:border-zinc-700 rounded-lg text-sm focus:ring-2 focus:ring-[#14a800] outline-none w-48"
              />
            </div>
            <select 

          ...
          <div className="bg-white rounded-3xl border border-zinc-200 shadow-xl p-8 mb-8 flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-4">
                <button className="px-8 py-3 bg-[#14a800] hover:bg-[#118a00] text-white font-bold rounded-xl transition-colors shadow-md">
                  Hire Agency
                </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white border border-zinc-200 rounded-3xl p-8">
                <h2 className="text-xl font-bold text-zinc-900 mb-6 flex items-center gap-2">
                  <Users className="w-5 h-5 text-[#14a800]" /> Core Team Members
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[1, 2, 3, 4].map(i => (
                    <div key={i} className="flex items-center gap-4 p-4 border border-zinc-100 rounded-xl hover:border-[#14a800]/20 transition-colors">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-surface-dark rounded-3xl p-8 text-white relative overflow-hidden">
                <div className="absolute -right-10 -bottom-10 w-40 h-40 bg-[#14a800] rounded-full blur-3xl opacity-50"></div>

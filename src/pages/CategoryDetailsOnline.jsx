    ...
    return (
      <div className="container mx-auto px-4 md:px-8 py-20">
        <div className="bg-white rounded-3xl border border-zinc-200 p-10 text-center">
          ...
          <Link className="text-[#14a800] font-bold" to="/categories">
            Back to categories
          </Link>
        </div>
      </div>
    ...
    <>
      <div className="bg-surface-dark text-white pt-16 pb-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 text-[#14a800] font-medium mb-4">
              <Link className="hover:text-[#14a800]" to="/categories">
                Categories
              </Link>
              <span>/</span>
      ...
      <div className="container mx-auto px-4 md:px-8 py-12">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link to={`/search-results?mode=online&category=${category}`} className="text-[#14a800] font-bold flex items-center gap-1">

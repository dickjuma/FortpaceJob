        ...
        <div className="container mx-auto px-4 md:px-8 max-w-7xl">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <div className="flex items-center gap-3">
              <Link to="/post-job" className="px-6 py-2.5 bg-[#2bb75c] hover:bg-[#1d8d38] text-white font-bold rounded-xl transition-colors shadow-sm">
                Post New Job
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm flex items-center gap-4 hover:border-[#2bb75c]/50 transition-colors cursor-pointer">
              <div className="w-12 h-12 rounded-xl bg-[#2bb75c]/5 text-[#2bb75c] flex items-center justify-center shrink-0"><Briefcase className="w-6 h-6" /></div>
              <div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm flex items-center gap-4 hover:border-[#2bb75c]/50 transition-colors cursor-pointer">
              <div className="w-12 h-12 rounded-xl bg-[#2bb75c]/5 text-[#2bb75c] flex items-center justify-center shrink-0"><Users className="w-6 h-6" /></div>
              <div>
            ...
            <div className="lg:w-2/3 space-y-8">
              ...
              <div className="bg-white border border-zinc-200 rounded-3xl p-6 md:p-8 shadow-sm">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <Link to="/contracts" className="text-[#2bb75c] text-sm font-bold hover:underline">View All</Link>
                </div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="border border-zinc-100 rounded-2xl p-5 hover:border-[#2bb75c]/20 transition-colors">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex-1 h-2 bg-zinc-100 rounded-full overflow-hidden">
                          <div className={`h-full ${contract.progress > 80 ? 'bg-success' : 'bg-[#2bb75c]'}`} style={{ width: `${contract.progress}%` }}></div>
                        </div>
            ...
            <div className="lg:w-1/3 space-y-8">
              ...
              <div className="bg-white border border-zinc-200 rounded-3xl p-6 shadow-sm">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <Link to="/jobs" className="text-[#2bb75c] text-sm font-bold hover:underline">Manage</Link>
                </div>
                
                <div className="space-y-4">
                  <div className="group cursor-pointer">
                    <div className="font-bold text-zinc-900 group-hover:text-[#2bb75c] transition-colors">Senior Mobile App Developer</div>
                  ...
                  <div className="group cursor-pointer">
                    <div className="font-bold text-zinc-900 group-hover:text-[#2bb75c] transition-colors">UI/UX Audit</div>
                    <div className="text-sm text-zinc-500 mb-2">Draft • Last saved 1 hr ago</div>
                    <button className="text-[#2bb75c] text-xs font-bold hover:underline">Finish posting</button>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-zinc-900 to-zinc-800 rounded-3xl p-6 shadow-xl text-white relative overflow-hidden">
                <div className="absolute top-0 right-0 -mr-4 -mt-4 w-24 h-24 bg-[#2bb75c] rounded-full blur-2xl opacity-40"></div>
                <h3 className="font-bold text-lg mb-2 relative z-10 flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-[#2bb75c] animate-pulse"></span> AI Insights
                </h3>

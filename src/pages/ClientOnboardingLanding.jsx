          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <button className="px-8 py-4 bg-surface-dark hover:bg-zinc-800 text-white font-bold rounded-xl transition-all shadow-xl shadow-zinc-900/20 flex items-center justify-center gap-2 text-lg">
              ...
              <div className="flex items-center gap-6 text-sm font-bold text-zinc-500">
                ...
                <span className="flex items-center gap-2"><Zap className="w-5 h-5 text-brand-500" /> Instant Matching</span>
              </div>
            </div>

            <div className="flex-1 w-full max-w-lg relative">
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-600 to-purple-600 rounded-[3rem] rotate-3 opacity-20 blur-xl"></div>
              <div className="bg-white rounded-[3rem] border border-zinc-200 shadow-2xl p-10 relative z-10">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-4 border border-zinc-200 rounded-2xl hover:border-brand-500 cursor-pointer transition-colors group">
                      <span className="font-bold text-zinc-700 group-hover:text-brand-600">{role}</span>
                      <Search className="w-5 h-5 text-zinc-400 group-hover:text-brand-500" />
                    </div>
                  ))}
                </div>

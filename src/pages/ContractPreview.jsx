        ...
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
            ...
            <div className="p-8 border-b border-zinc-200 grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10 bg-surface/50">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-zinc-900 flex items-center gap-1">Sarah Jenkins <ShieldCheck className="w-4 h-4 text-[#14a800]" /></div>
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tfoot className="bg-surface border-t border-zinc-200">
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3 font-black text-[#14a800] text-right">$2,100.00</td>
                    </tr>
                  </tfoot>
                </table>
              </div>
          ...
          <div className="bg-white rounded-2xl border border-zinc-200 p-6 shadow-lg flex flex-col md:flex-row items-center justify-between gap-6 sticky bottom-6 z-50">
            <div className="flex items-center gap-3 w-full md:w-auto">
              <input type="checkbox" id="agree" className="w-5 h-5 rounded border-zinc-300 text-[#14a800] focus:ring-[#14a800]/20 cursor-pointer" />
              <label htmlFor="agree" className="text-sm font-medium text-zinc-700 cursor-pointer">
                I agree to the <a href="#" className="text-[#14a800] hover:underline">Terms of Service</a> and Escrow Instructions.
              </label>
            </div>

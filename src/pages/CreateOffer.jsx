            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 border border-zinc-200 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button className="text-sm text-[#14a800] font-medium">Change Job</button>
                </div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-zinc-200 shadow-sm">
                ...
                <div className="space-y-4">
                  {offerType === 'milestone' ? (
                    <div className="p-4 border border-[#14a800]/20 bg-[#14a800]/5/50 rounded-xl space-y-4">
                      <div className="flex justify-between items-end gap-4">
                        <div className="flex-1">
                          <label className="block text-xs font-medium text-zinc-700 mb-1">Milestone 1: Wireframes</label>
                          <input type="text" defaultValue="Deliver initial wireframes for homepage" className="w-full bg-white border border-zinc-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#14a800]/20" />
                        </div>
                        <div className="w-32">
                          ...
                          <div className="relative">
                            ...
                            <input type="number" defaultValue="500" className="w-full bg-white border border-zinc-300 rounded-lg pl-7 pr-3 py-2 text-sm focus:outline-none focus:border-[#14a800]/20" />
                          </div>
                        </div>
                        <div className="w-32">
                          <label className="block text-xs font-medium text-zinc-700 mb-1">Due Date</label>
                          <input type="date" className="w-full bg-white border border-zinc-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#14a800]/20 text-zinc-600" />
                        </div>
                        <button className="p-2 text-zinc-400 hover:text-rose-500 mb-0.5"><Trash2 className="w-4 h-4" /></button>
                      </div>
                      <button className="text-sm font-medium text-[#14a800] flex items-center gap-1 hover:text-[#14a800]">
                    ...
                    <div className="flex gap-4">
                      <div className="w-1/2">
                        ...
                        <div className="relative">
                          <span className="absolute left-3 top-1/2 -tranzinc-y-1/2 text-zinc-500">$</span>
                          <input type="number" placeholder="0.00" className="w-full bg-surface border border-zinc-300 rounded-lg pl-7 pr-3 py-2.5 focus:outline-none focus:border-[#14a800]/20 focus:bg-white" />
                        </div>
                      </div>
                      <div className="w-1/2">
                        <label className="block text-sm font-medium text-zinc-700 mb-1">Estimated Completion</label>
                        <input type="date" className="w-full bg-surface border border-zinc-300 rounded-lg px-3 py-2.5 focus:outline-none focus:border-[#14a800]/20 focus:bg-white text-zinc-600" />
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-zinc-200 shadow-sm">
                ...
                <div className="mb-4">
                  <textarea rows="4" placeholder="Detail exactly what needs to be delivered for this offer..." className="w-full bg-surface border border-zinc-200 rounded-xl px-4 py-3 focus:outline-none focus:border-[#14a800]/20 focus:bg-white"></textarea>
                </div>
            ...
            <div className="w-full lg:w-96 flex-shrink-0">
              <div className="bg-surface-dark text-white rounded-2xl p-6 shadow-xl sticky top-24">
                <h3 className="font-bold text-lg mb-6 flex items-center gap-2">
                  <FileText className="w-5 h-5 text-[#14a800]" /> Offer Preview
                </h3>
                ...
                <div className="space-y-3 mb-6">
                  <label className="flex items-start gap-3 cursor-pointer group">
                    <div className="mt-0.5 w-4 h-4 rounded border border-zinc-600 bg-zinc-800 flex items-center justify-center group-hover:border-[#14a800]/20">
                      <CheckCircle2 className="w-3 h-3 text-[#14a800] opacity-0" />
                    </div>
                ...
                <Link to="/contract/preview" className="w-full flex justify-center items-center gap-2 py-3.5 bg-[#14a800] hover:bg-[#118a00] text-white font-bold rounded-xl transition-colors shadow-lg shadow-blue-900/50">

  ...
  return (
    <>
      ...
      <div className="bg-surface-dark text-white pt-20 pb-24 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 -mr-40 -mt-40 w-96 h-96 rounded-full bg-brand-600/20 blur-3xl"></div>
        <div className="absolute bottom-0 left-0 -ml-40 -mb-40 w-96 h-96 rounded-full bg-brand-600/20 blur-3xl"></div>
        
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-500/10 border border-brand-500/20 text-brand-400 font-bold tracking-wide text-sm mb-6">
                <Building2 className="w-4 h-4" /> FORTSPACE ENTERPRISE
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight">
                Scale your workforce with <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">global talent</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <button className="w-full sm:w-auto px-8 py-4 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-xl transition-colors shadow-lg shadow-blue-900/50 flex items-center justify-center gap-2">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl border border-zinc-200 shadow-sm hover:shadow-xl hover:-tranzinc-y-1 transition-all duration-300">
              ...
              <Link to="/enterprise/teams" className="text-brand-600 font-bold flex items-center gap-1 hover:text-brand-700">
            ...
            <div className="bg-white p-8 rounded-2xl border border-zinc-200 shadow-sm hover:shadow-xl hover:-tranzinc-y-1 transition-all duration-300">
              ...
              <Link to="/enterprise/analytics" className="text-brand-600 font-bold flex items-center gap-1 hover:text-brand-700">

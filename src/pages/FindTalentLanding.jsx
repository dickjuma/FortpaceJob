        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-md p-1.5 shadow-2xl flex max-w-3xl mx-auto mb-6">
              <input
                className="flex-1 bg-transparent border-none outline-none text-zinc-900 px-4 py-3 placeholder-zinc-500 font-medium"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {displayCategories.map((category) => (
                <CategoryTile
                  ...
                  countLabel="profiles"
                  badge={category.kind}
                  to={`/find-talent?section=${encodeURIComponent(category.slug || category.id)}`}
                />
              ))}
            </div>
          </div>

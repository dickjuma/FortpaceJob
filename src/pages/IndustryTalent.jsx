      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
          {industries.map((industry) => (
            <Link
              className="bg-white rounded-3xl p-8 border border-zinc-200 hover:border-brand-300 hover:shadow-xl transition-all group flex flex-col"
              key={industry.id}
            ...
            >
              ...
              <div className="mt-6 text-brand-600 font-bold">Explore talent</div>
            </Link>
          ))}
        </div>
      </div>

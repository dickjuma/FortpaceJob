          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-2/3">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="bg-white border border-zinc-200 rounded-2xl p-6 flex flex-col sm:flex-row justify-between items-center gap-6 shadow-sm hover:border-[#4C1D95]/50 transition-colors">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-sm text-zinc-600">
                        By <span className="font-bold text-zinc-900 flex items-center gap-1">{pkg.pro} <ShieldCheck className="w-3 h-3 text-[#4C1D95]" /></span> • ⭐ {pkg.rating}
                      </div>
                    </div>
            ...
            <div className="lg:w-1/3">
              <div className="bg-white border border-zinc-200 rounded-3xl p-6 shadow-xl sticky top-24">
                ...
                <button className="w-full py-4 bg-[#4C1D95] hover:bg-[#22C55E] text-white font-bold rounded-xl shadow-lg shadow-blue-900/20 transition-all flex items-center justify-center gap-2 mb-4">

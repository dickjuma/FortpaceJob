      ...
      <div className="bg-surface min-h-screen py-10">
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <button className="flex items-center gap-2 bg-[#14a800] hover:bg-[#118a00] text-white px-5 py-2.5 rounded-xl font-bold shadow-sm transition-colors">
          ...
          <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden mb-8">
            <div className="p-4 border-b border-zinc-200 flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="relative w-full sm:w-96">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-surface border border-zinc-200 rounded-lg text-sm focus:outline-none focus:border-[#14a800]/20 focus:bg-white"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
              ...
              {/* Team Card 1 */}
              <div className="border border-zinc-200 rounded-xl p-5 hover:border-[#14a800]/50 transition-colors group cursor-pointer">
                <div className="flex justify-between items-start mb-4">
                  <div className="w-12 h-12 bg-[#14a800]/10 text-[#14a800] rounded-lg flex items-center justify-center font-bold text-xl">
                    FE
                  </div>
                ...
                <h3 className="font-bold text-zinc-900 text-lg mb-1 group-hover:text-[#14a800] transition-colors">Frontend Engineering</h3>
              ...
              <div className="border border-zinc-200 rounded-xl p-5 hover:border-[#14a800]/50 transition-colors group cursor-pointer">
                ...
                <h3 className="font-bold text-zinc-900 text-lg mb-1 group-hover:text-[#14a800] transition-colors">Design & Research</h3>
              ...
              <div className="border border-zinc-200 rounded-xl p-5 hover:border-[#14a800]/50 transition-colors group cursor-pointer">
                ...
                <h3 className="font-bold text-zinc-900 text-lg mb-1 group-hover:text-[#14a800] transition-colors">Quality Assurance</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm flex items-start gap-4">
              <div className="p-3 bg-[#14a800]/5 text-[#14a800] rounded-xl">
              ...
              <div>
                ...
                <button className="text-sm font-bold text-[#14a800] hover:text-[#14a800]">View Budget Report</button>
              </div>
            </div>

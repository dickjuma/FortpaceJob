        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-white flex items-center gap-2">
              <Video className="w-6 h-6 text-[#4C1D95]" /> Meetings & Interviews
            </h1>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="px-2.5 py-1 rounded-full text-xs font-bold bg-[#4C1D95]/10 text-[#4C1D95] border border-[#4C1D95]/20">
                    ...
                    {item.videoLink && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#4C1D95] hover:bg-[#22C55E] text-white rounded-xl text-sm font-bold transition-colors shrink-0"
                      >

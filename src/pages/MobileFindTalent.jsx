              ...
              <div className="relative w-[300px] h-[600px] bg-zinc-800 rounded-[3rem] border-8 border-zinc-800 shadow-2xl overflow-hidden shadow-blue-900/50">
                ...
                <div className="w-full h-full bg-surface flex flex-col">
                  ...
                  <div className="flex-1 p-4 space-y-4">
                    <div className="bg-[#2bb75c] text-white p-3 rounded-2xl rounded-tr-sm ml-8 text-sm shadow-sm">
                    ...
                    <div className="bg-white border border-zinc-200 rounded-xl p-4 mt-8 shadow-sm">
                      ...
                      <div className="text-lg font-black text-[#2bb75c] mb-3">$1,200.00</div>
                      <button className="w-full py-2 bg-[#2bb75c] text-white text-sm font-bold rounded-lg flex items-center justify-center gap-1">

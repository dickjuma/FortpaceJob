    ...
    <div className="min-h-screen bg-zinc-50 pt-28 pb-20">
      <div className="container mx-auto px-4 md:px-8 max-w-6xl">
        <div className="text-center mb-14">
          <p className="text-[#14a800] font-bold text-sm uppercase tracking-widest mb-3">Freelancer plans</p>
        ...
        {isAuthenticated && mySub && (
          <div className="mb-10 p-4 bg-white border border-[#14a800]/30 rounded-2xl flex flex-wrap items-center justify-between gap-4">
            <div>
            ...
            return (
              <div
                ...
                className={`relative bg-white rounded-3xl border-2 p-8 flex flex-col shadow-sm transition-all ${
                  plan.id === 'sme'
                    ? 'border-[#14a800] shadow-lg scale-[1.02]'
                    : 'border-zinc-200 hover:border-zinc-300'
                } ${disabled ? 'opacity-75' : ''}`}
              >
                {plan.id === 'sme' && (
                  <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#14a800] text-white text-xs font-bold px-3 py-1 rounded-full">
                    Most popular
                  </span>
                )}
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2.5 rounded-xl bg-[#14a800]/10 text-[#14a800]">
                ...
                <button
                  ...
                  className={`w-full py-3 rounded-xl font-bold transition-colors ${
                    isCurrent
                      ...
                      : plan.id === 'sme'
                        ? 'bg-[#14a800] text-white hover:bg-[#118a00]'
        ...
        <p className="text-center text-xs text-zinc-500 mt-8">
          ...
          <Link to="/terms" className="text-[#14a800] hover:underline">
            Terms
          </Link>
        </p>
      </div>

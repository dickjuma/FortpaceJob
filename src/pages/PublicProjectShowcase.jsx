      ...
      <div className="bg-surface min-h-screen py-16">
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#14a800]/10 text-[#14a800] text-xs font-bold uppercase tracking-wider mb-6">
              <span className="w-2 h-2 rounded-full bg-[#14a800] animate-pulse"></span> Live Feed
            </div>
                  ...
                  <div className="lg:w-3/5 p-8 flex flex-col justify-between">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <Link to={`/portfolio/case-study/${project.id}`} className="text-zinc-400 hover:text-[#14a800] transition-colors p-2">
                          <ExternalLink className="w-5 h-5" />
                        </Link>
                      </div>

                      <h2 className="text-2xl font-bold text-zinc-900 mb-6 leading-tight hover:text-[#14a800] transition-colors cursor-pointer">
                        {project.title}
                      </h2>
                      ...
                      <div className="flex items-center gap-6 bg-surface border border-zinc-100 rounded-2xl p-4 mb-6">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2">
                            <div className="w-8 h-8 bg-[#14a800]/10 text-[#14a800] rounded-lg flex items-center justify-center font-bold border border-[#14a800]/20">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <div className="font-bold text-zinc-900 flex items-center gap-1 leading-tight">
                                {project.freelancer} <ShieldCheck className="w-3 h-3 text-[#14a800]" />
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="flex items-center gap-4 mt-6">
                      <button className="flex items-center gap-1.5 text-zinc-500 hover:text-[#14a800] font-medium text-sm transition-colors">

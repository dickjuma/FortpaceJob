...
import { formatCompactNumber, getMarketplaceTalent, getTalentCategories } from './find-talent/talentMarketplaceData';
  ...
  return (
    <>
      <div className="bg-surface-dark pt-16 pb-20 border-b border-zinc-800 relative overflow-hidden">
        <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 rounded-full bg-brand-500/10 blur-3xl" />
        <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 rounded-full bg-brand-500/10 blur-3xl" />
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-zinc-900 mb-3 group-hover:text-brand-600 transition-colors">{category.name}</h3>
                  ...
                  <div className="flex items-center justify-between text-sm font-medium">
                    ...
                    <ArrowRight className="w-5 h-5 text-zinc-300 group-hover:text-brand-600 group-hover:tranzinc-x-1 transition-all" />
                  </div>
                </Link>
              </motion.div>
            );

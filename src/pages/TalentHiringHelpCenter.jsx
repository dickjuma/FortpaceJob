      ...
      <div className="bg-surface-dark text-white pt-20 pb-24 relative">
        <div className="container mx-auto px-4 md:px-8 relative z-10 text-center max-w-3xl">
          ...
          <div className="max-w-2xl mx-auto relative">
            ...
            <input type="text" placeholder="Search for 'escrow', 'disputes', or 'milestones'..." className="w-full bg-white text-zinc-900 px-12 py-5 rounded-2xl outline-none focus:ring-4 focus:ring-[#14a800]/50 text-lg shadow-xl" />
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="bg-white p-8 rounded-3xl border border-zinc-200 hover:shadow-lg transition-shadow group cursor-pointer">
              <div className="w-12 h-12 bg-[#14a800]/10 text-[#14a800] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              ...
              <div className="text-[#14a800] font-bold text-sm flex items-center gap-1">Browse Articles <ChevronRight className="w-4 h-4" /></div>
            </div>

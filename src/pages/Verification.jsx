          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-8 md:p-12 border-b md:border-b-0 md:border-r border-zinc-100">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 bg-[#4C1D95]/10 rounded-full flex items-center justify-center">
                  <Lock className="w-8 h-8 text-[#4C1D95]" />
                </div>
                <div>
            ...
            <div className="p-8 md:p-12 bg-surface/50">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 bg-[#4C1D95]/10 rounded-full flex items-center justify-center">
                  <Building className="w-8 h-8 text-[#4C1D95]" />
                </div>
                <div>

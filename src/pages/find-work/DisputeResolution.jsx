          ...
          <form onSubmit={handleSubmit} className="bg-white border border-zinc-200 rounded-3xl p-6 md:p-10 shadow-sm">
            ...
            <div className="mb-6">
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-surface border border-zinc-200 rounded-xl focus:border-[#14a800]/20 focus:outline-none font-medium text-zinc-900 cursor-pointer mb-6"
              >

              ...
              {filtered.map((provider) => (
                <div key={provider.id} className="bg-white border border-zinc-200 rounded-3xl p-6 hover:shadow-md transition-shadow relative">
                  ...
                  <div className="flex flex-col items-center text-center mb-6">
                    ...
                    />
                    <Link to={`/seller/${provider.id}`} className="font-bold text-zinc-900 text-lg hover:text-[#14a800] transition-colors">{provider.name}</Link>
                  ...
                  <div className="flex gap-2">
                    ...
                    <Link to="/post-job" className="flex-1 py-2.5 bg-[#14a800] hover:bg-[#118a00] text-white font-bold rounded-xl shadow-sm transition-colors text-sm flex items-center justify-center gap-2">

          ...
          <form onSubmit={handleInvite} className="bg-white border border-zinc-200 rounded-3xl p-6 md:p-8 shadow-sm mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="flex-1 px-4 py-3 bg-surface border border-zinc-200 rounded-xl focus:border-[#14a800]/20 focus:outline-none font-medium text-zinc-900"
              />
              <select
                value={role}
                onChange={(e) => setRole(e.target.value)}
                className="px-4 py-3 bg-surface border border-zinc-200 rounded-xl focus:border-[#14a800]/20 focus:outline-none font-bold text-zinc-700 cursor-pointer w-full sm:w-auto"
              >
              ...
              <button
                type="submit"
                disabled={submitting}
                className="px-6 py-3 bg-[#14a800] hover:bg-[#118a00] text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2 disabled:opacity-60"
              >
                    ...
                    <tr key={member.id} className="hover:bg-surface transition-colors">
                      ...
                      <td className="p-6 hidden sm:table-cell">
                        <div className="flex items-center gap-2">
                          <Shield className={`w-4 h-4 ${member.role === 'Owner' ? 'text-rose-500' : 'text-[#14a800]'}`} />
                          <div>

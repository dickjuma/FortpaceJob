      ...
      <div className="bg-surface min-h-screen py-10">
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded-3xl border border-zinc-200 shadow-sm">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 bg-[#14a800]/10 text-[#14a800] rounded-lg"><Users className="w-5 h-5" /></div>
                <div className="font-bold text-zinc-500">Talent Hired</div>
              </div>
              <div className="text-3xl font-black text-zinc-900">{talentHired}</div>
              <div className="text-sm font-bold text-[#14a800] mt-2">{jobsPosted} jobs posted</div>
            </div>
            ...
            <div className="bg-white p-6 rounded-3xl border border-zinc-200 shadow-sm">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 bg-[#14a800]/10 text-[#14a800] rounded-lg"><TrendingUp className="w-5 h-5" /></div>

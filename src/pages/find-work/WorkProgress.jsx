...
function milestoneStatusClass(status) {
  ...
  if (['IN_PROGRESS', 'ACTIVE'].includes(value)) return 'bg-[#14a800] animate-pulse';
  return 'bg-zinc-300';
}
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="px-2.5 py-1 bg-[#14a800]/10 text-[#14a800] border border-[#14a800]/20 rounded-lg text-xs font-bold uppercase tracking-wider">
                  {statusLabel}
                </span>
              </div>
                ...
                <div className="flex overflow-x-auto border-b border-zinc-200 bg-surface/50">
                  {['overview', 'messages', 'files'].map((tab) => (
                    <button
                      ...
                      className={`px-8 py-4 font-bold text-sm whitespace-nowrap transition-colors border-b-2 capitalize ${activeTab === tab ? 'border-[#14a800]/20 text-[#14a800] bg-white' : 'border-transparent text-zinc-500 hover:text-zinc-900 hover:bg-surface'}`}
                    >
                      {tab}
                    </button>
                  ))}
                ...
                <div className="p-6 md:p-8">
                  {activeTab === 'overview' && (
                    <div className="space-y-8">
                      <div>
                        ...
                        <div className="relative border-l-2 border-zinc-200 ml-3 space-y-8">
                          ...
                          {milestones.length > 0 ? (
                            ...
                            <div className="relative pl-6">
                              <div className="absolute left-[-13px] top-0 bg-[#14a800]/10 border-4 border-white rounded-full p-1">
                                <div className="w-3 h-3 bg-[#14a800] rounded-full animate-pulse" />
                              </div>
                              <div className="font-bold text-[#14a800]">In Development</div>
                      ...
                      <div className="bg-[#14a800]/5 border border-[#14a800]/20 rounded-2xl p-6 text-center">
                        <CheckCircle2 className="w-12 h-12 text-[#14a800] mx-auto mb-3" />
                        <h4 className="text-lg font-bold text-[#14a800] mb-1">
                        ...
                        {!isCompleted && (
                          <button
                            ...
                            className="px-6 py-2.5 bg-white border border-[#14a800]/20 hover:bg-[#14a800]/10 text-[#14a800] font-bold rounded-xl transition-colors text-sm"
                          >
                            Request Update
                          </button>
                        )}

...
import { useFeaturedGigs, useGigCategories } from '../../common/hooks/useGigsMarketplace';
    ...
    <>
      <div className="bg-[#14a800] text-white pt-24 pb-20 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-full h-full opacity-20 pointer-events-none">
          ...
          <div className="absolute bottom-10 right-10 w-64 h-64 bg-[#14a800] rounded-full blur-[100px]"></div>
        </div>
          ...
          <div>
            <div className="flex justify-between items-end mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 flex items-center gap-2">
                <TrendingUp className="w-6 h-6 text-[#14a800]" /> Trending Services
              </h2>

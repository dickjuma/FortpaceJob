...
import { Search, Star, TrendingUp, Sparkles, Monitor, Palette, Code, Video } from 'lucide-react';
import { Link, useNavigate } from 'react-router-dom';

const MOCK_CATEGORIES = [
  { id: 'graphics', name: 'Graphics & Design', icon: Palette, count: '12.5k' },
  { id: 'programming', name: 'Programming & Tech', icon: Code, count: '8.2k' },
  { id: 'video', name: 'Video & Animation', icon: Video, count: '5.1k' },
  { id: 'digital', name: 'Digital Marketing', icon: Monitor, count: '9.4k' },
];

const MOCK_FEATURED = [
  { id: 1, title: 'I will design a modern minimalist logo for your startup', seller: 'Sarah Design', rating: 4.9, reviews: 1042, price: 25, img: 'https://images.unsplash.com/photo-1626785774573-4b799315345d?auto=format&fit=crop&w=600&q=80' },
  { id: 2, title: 'I will build a responsive React web application', seller: 'DevMasterPro', rating: 5.0, reviews: 856, price: 150, img: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=600&q=80' },
  { id: 3, title: 'I will edit your YouTube videos into engaging shorts', seller: 'VideoNinja', rating: 4.8, reviews: 432, price: 15, img: 'https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?auto=format&fit=crop&w=600&q=80' },
  { id: 4, title: 'I will do comprehensive technical SEO audit', seller: 'RankBooster', rating: 4.9, reviews: 210, price: 50, img: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=80' }
];
...
const GigsHub = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="bg-[#0b291d] text-white pt-24 pb-20 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-full h-full opacity-20 pointer-events-none">
          <div className="absolute top-10 left-10 w-64 h-64 bg-success rounded-full blur-[100px]"></div>
          <div className="absolute bottom-10 right-10 w-64 h-64 bg-brand-500 rounded-full blur-[100px]"></div>
        </div>

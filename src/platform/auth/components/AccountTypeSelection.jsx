...
const roleOptions = [
  {
    ...
    title: 'Client',
    icon: Users,
    useCase: 'Hire freelancers, agencies, businesses, and onsite professionals.',
...
const accountTypeOptions = [
  ...
  },
  {
    ...
    title: 'Business',
    icon: Building2,
    useCase: 'For companies, agencies, managed teams, and enterprise hiring.',
    features: ['Company Verification', 'Team-Friendly Setup', 'Advanced Controls'],
    examples: ['Startup', 'Procurement team', 'Agency'],
    themeClass: 'amber',
  },
];
      ...
      {currentStep === 1 ? (
        <section>
          <div className="mb-6 rounded-2xl border border-zinc-200/80 bg-zinc-50/70 p-5 dark:border-zinc-800 dark:bg-zinc-900/40 sm:p-6">
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#4C1D95]">Step 1</p>
        ...
        <section>
          <div className="mb-6 rounded-2xl border border-zinc-200/80 bg-zinc-50/70 p-5 dark:border-zinc-800 dark:bg-zinc-900/40 sm:p-6">
            ...
            <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              {selectedRole && (
                <div className="inline-flex items-center rounded-full bg-[#4C1D95]/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.2em] text-[#4C1D95] dark:text-[#4C1D95]">

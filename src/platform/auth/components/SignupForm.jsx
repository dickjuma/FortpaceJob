  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (data?.requiresEmailVerification) {
        ...
        sessionStorage.setItem('pendingVerificationRole', store.selectedRole);
        toast.success('Account created. Please verify your email to continue.');
        navigate('/auth/verify-email', {
          state: { email, role: store.selectedRole },
          replace: true,
        });
        return;
      }
      ...
      const { getDashboardPathForRole } = await import('../utils/authRouting');

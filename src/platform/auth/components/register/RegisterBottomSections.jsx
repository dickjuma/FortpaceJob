...
const BENEFITS = [
  ...
  },
  {
    ...
    description: 'Support individual professionals and enterprise hiring workflows in one unified marketplace.',
    icon: Users2,
  },
  {
...
const BADGES = [
  ...
  'Scalable for freelancers and enterprise teams',
];
...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'Business accounts typically unlock additional company details, team setup, and verification workflows after core registration.',
  },
  {
    ...
    <div className="border-t border-zinc-200 bg-transparent px-4 py-14 dark:border-zinc-800 sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-[88rem] flex-col gap-12">
        <section className="grid gap-8 xl:grid-cols-[0.9fr_1.1fr] xl:items-start">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#4C1D95]">
              Why join us
            </p>
        ...
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {BADGES.map((badge) => (
            ...
            >
              <LockKeyhole className="h-4 w-4 text-[#4C1D95]" />
              <span>{badge}</span>
            </div>
          ))}
        </section>

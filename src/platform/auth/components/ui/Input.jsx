  ...
  return (
    <div className="w-full relative pb-1">
      <div className={cn(
        ...
        isFocused && !error ? "glow-border ring-2 ring-#4C1D95]/20" : "",
        ...
        {Icon && (
          <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
            <Icon className={cn(
              ...
              error ? "text-red-400" : 
              isFocused ? "text-[#4C1D95]" : "text-zinc-400"
            )} />
          </div>
        )}
        ...
        <input
          ...
          className={cn(
            ...
            error
              ...
              : "border-zinc-200 text-zinc-900 focus:border-[#4C1D95]/20 dark:border-zinc-700 dark:text-white dark:focus:border-[#4C1D95]/20",
            className
          )}
          {...props}
        />

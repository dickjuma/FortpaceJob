  ...
  return (
    <div className="min-h-screen bg-surface dark:bg-surface-dark font-sans selection:bg-[#4C1D95]/30 overflow-x-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        <div className="absolute top-0 right-0 w-full h-96 bg-gradient-to-b from-[#4C1D95]/10 to-transparent" />
      </div>
        ...
        <div className="flex-1 w-full max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h1 className="text-3xl sm:text-4xl font-extrabold text-zinc-900 dark:text-white tracking-tight mb-3">
              Set your <span className="bg-gradient-to-r from-[#4C1D95] to-violet-600 bg-clip-text text-transparent">hourly rate</span>
            </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 shadow-sm">
                <div className="flex justify-between items-end mb-6">
                  ...
                  <select 
                    ...
                    className="bg-zinc-100 dark:bg-zinc-800 border-none rounded-xl text-sm font-bold text-zinc-700 dark:text-zinc-300 py-2 pl-3 pr-8 focus:ring-2 focus:ring-[#4C1D95] cursor-pointer"
                  >
                ...
                <div className="space-y-4 pt-6 border-t border-zinc-100 dark:border-zinc-800">
                  ...
                  <div className="flex justify-between items-center text-sm">
                    <span className="font-semibold text-zinc-500 flex items-center gap-1">
                      Forte Service Fee (10%) <ShieldCheck className="w-3.5 h-3.5 text-[#4C1D95]" />
                    </span>
                  ...
                  <div className="flex justify-between items-center text-base p-4 bg-surface dark:bg-zinc-800/50 rounded-xl border border-zinc-100 dark:border-zinc-700">
                    ...
                    <span className="font-black text-[#4C1D95]">{currentSymbol}{netRate.toFixed(2)} <span className="text-sm text-[#4C1D95]/70">/hr</span></span>
                  </div>
                </div>
              </div>

              {/* Fixed Price Toggle */}
              <div className="bg-white dark:bg-surface-dark rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm flex items-center justify-between cursor-pointer hover:border-[#4C1D95]/50 transition-colors" onClick={() => setAcceptsFixed(!acceptsFixed)}>
                <div>
                  <h3 className="text-base font-bold text-zinc-900 dark:text-white mb-1 flex items-center gap-2">
                    <Target className="w-4 h-4 text-[#4C1D95]" /> Accept Fixed-Price Projects
                  </h3>
                ...
                <div className={cn(
                  ...
                  acceptsFixed ? "bg-[#4C1D95]" : "bg-zinc-200 dark:bg-zinc-700"
                )}>
                  <motion.div 
                    layout 
            ...
            <div className="flex-1 w-full space-y-6">
              ...
              <motion.div 
                ...
                className="bg-gradient-to-br from-[#4C1D95] to-violet-600 rounded-3xl p-6 text-white shadow-xl shadow-[#4C1D95]/25/20"
              >
                ...
                <p className="text-[#4C1D95] text-sm leading-relaxed mb-6">
              ...
              <div className="bg-surface-dark rounded-3xl p-6 text-white shadow-xl relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#4C1D95]/20 rounded-bl-full pointer-events-none" />
                <div className="flex items-center gap-2 mb-6">
                  <Calculator className="w-5 h-5 text-[#4C1D95]" />
                ...
                <div className="mb-4">
                  ...
                  <input 
                    ...
                    className="w-full h-2 bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-#4C1D95]"
                  />
                </div>
                ...
                <div className="pt-4 border-t border-zinc-800 flex justify-between items-end">
                  <div>
                    ...
                    <p className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#4C1D95] to-violet-400">
        ...
        <div className="fixed bottom-0 left-0 right-0 border-t border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-surface-dark/80 backdrop-blur-md z-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-8 py-3 bg-surface-dark dark:bg-white text-white dark:text-zinc-900 hover:bg-[#4C1D95] dark:hover:bg-[#4C1D95] hover:text-white text-sm font-bold rounded-xl shadow-lg hover:shadow-[#4C1D95]/25/25 transition-all"
            >

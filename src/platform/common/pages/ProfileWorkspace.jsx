...
import ManageGigs from "../../../freelancer/components/Findwork/Gigs/ManageGigs";
import CreateGig from "../../../freelancer/components/Findwork/Gigs/CreateGig";
import ProposalManager from "../../../freelancer/components/Findwork/BuyerRequests/ProposalManager";
import Analytics from "../../../freelancer/components/Findwork/Performance/Analytics";
import SkillLevels from "../../../freelancer/components/Findwork/Performance/SkillLevels";
import Badges from "../../../freelancer/components/Findwork/Performance/Badges";
import Promotions from "../../../freelancer/components/Findwork/Performance/Promotions";
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {sections.map((card) => (
          <Link
            key={card.to}
            to={card.to}
            className={`${shell.card} ${shell.border} rounded-2xl border p-5 transition hover:-tranzinc-y-0.5 hover:shadow-md`}
          >

  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 border border-zinc-200">
        ...
        <div className="w-14 h-14 rounded-2xl bg-[#4C1D95]/10 flex items-center justify-center mb-5">
          <Zap className="w-7 h-7 text-[#4C1D95]" />
        </div>
        ...
        <Link
          to="/pricing"
          onClick={onClose}
          className="flex items-center justify-center gap-2 w-full py-3.5 bg-[#4C1D95] hover:bg-[#22C55E] text-white font-bold rounded-xl transition-colors"
        >

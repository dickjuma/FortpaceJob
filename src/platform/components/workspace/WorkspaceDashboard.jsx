    ...
    <div className="flex h-[calc(100vh-64px)] overflow-hidden bg-surface-tertiary dark:bg-surface-dark-secondary font-sans">
      ...
      <div className="w-64 flex-shrink-0 bg-white dark:bg-surface-dark border-r border-gray-200 dark:border-surface-dark-border flex flex-col">
        <div className="p-4 border-b border-gray-200 dark:border-surface-dark-border">
          ...
          <p className="text-xs text-[#4C1D95] mt-1 font-medium">Active Workspace</p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto py-4">
          <div className="px-3 mb-6">
            ...
            <div className="space-y-1">
              <button className="w-full flex items-center px-2 py-1.5 bg-[#4C1D95]/5 dark:bg-[#4C1D95]/20 text-[#4C1D95] dark:text-[#4C1D95] rounded-md text-sm font-medium">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-white dark:bg-surface-dark">
        <div className="h-16 border-b border-gray-200 dark:border-surface-dark-border px-6 flex items-center justify-between flex-shrink-0">
          ...
          <div className="flex items-center gap-3">
            <div className="flex -space-x-2">
              <div className="w-8 h-8 rounded-full bg-[#4C1D95] border-2 border-white dark:border-surface-dark z-10"></div>
              <div className="w-8 h-8 rounded-full bg-[#4C1D95] border-2 border-white dark:border-surface-dark z-0"></div>
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          <div className="flex gap-4">
            <div className="w-10 h-10 rounded-full bg-[#4C1D95] shrink-0"></div>
            <div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <div className="flex items-center gap-3 p-3 border border-gray-200 dark:border-surface-dark-border rounded-xl w-64 bg-surface-tertiary dark:bg-surface-dark-secondary">
                  ...
                  <button className="text-gray-400 hover:text-[#4C1D95]"><Download className="w-4 h-4" /></button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-surface-dark-border bg-white dark:bg-surface-dark">
          <div className="flex items-end gap-2 bg-surface dark:bg-surface-dark-secondary border border-gray-200 dark:border-surface-dark-border rounded-2xl p-2 focus-within:ring-2 focus-within:ring-#4C1D95] focus-within:border-transparent transition-all">
            <button className="p-2 text-gray-400 hover:text-[#4C1D95] rounded-full">
            ...
            />
            <button className="p-2 bg-[#4C1D95] hover:bg-[#22C55E] text-white rounded-xl shadow-md transition-colors">

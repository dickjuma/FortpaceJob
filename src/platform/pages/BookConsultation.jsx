            ...
            <div className="w-full md:w-1/3 bg-surface-dark text-white p-8">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <div className="text-[#4C1D95] text-sm">Senior React Developer</div>
                </div>
              </div>
              
              <div className="space-y-6">
                <div className="flex gap-3 text-zinc-300">
                  <Clock className="w-5 h-5 text-[#4C1D95] flex-shrink-0" />
                  <div>
                ...
                <div className="flex gap-3 text-zinc-300">
                  <Video className="w-5 h-5 text-[#4C1D95] flex-shrink-0" />
                  <div>
                ...
                <div className="flex gap-3 text-zinc-300">
                  <FileText className="w-5 h-5 text-[#4C1D95] flex-shrink-0" />
                  <div>
            ...
            <div className="w-full md:w-2/3 p-8">
                  ...
                  <div className="flex gap-2 mb-8 overflow-x-auto pb-2">
                    {['Mon 16', 'Tue 17', 'Wed 18', 'Thu 19', 'Fri 20'].map(date => (
                      <button 
                        ...
                        className={`flex-1 min-w-[80px] py-4 rounded-xl border flex flex-col items-center justify-center gap-1 transition-all ${selectedDate === date ? 'border-[#4C1D95]/20 bg-[#4C1D95]/5 text-[#4C1D95] shadow-md ring-2 ring-#4C1D95]/20' : 'border-zinc-200 bg-white hover:border-[#4C1D95]/50'}`}
                      >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-8">
                    {TIME_SLOTS.map(time => (
                      <button 
                        ...
                        className={`py-3 rounded-lg border font-bold text-sm transition-all ${selectedTime === time ? 'border-[#4C1D95]/20 bg-[#4C1D95] text-white shadow-md' : 'border-zinc-200 bg-white text-zinc-700 hover:border-[#4C1D95]/50 hover:bg-surface'}`}
                      >
                        {time}
                      </button>
                    ))}
              ...
              {step === 2 && (
                <div>
                  ...
                  <div className="bg-[#4C1D95]/5 border border-[#4C1D95]/20 p-4 rounded-xl mb-6 flex items-center gap-4">
                    <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center text-[#4C1D95] font-bold border border-[#4C1D95]/20">
                  ...
                  <div className="space-y-4 mb-8">
                    <div>
                      ...
                      <input type="text" placeholder="e.g. E-commerce frontend rebuild" className="w-full border border-zinc-200 rounded-xl px-4 py-3 bg-surface focus:outline-none focus:border-[#4C1D95]/20 focus:bg-white" />
                    </div>
                    <div>
                      <label className="block text-sm font-bold text-zinc-700 mb-1">Estimated Budget (Optional)</label>
                      <input type="text" placeholder="$5k - $10k" className="w-full border border-zinc-200 rounded-xl px-4 py-3 bg-surface focus:outline-none focus:border-[#4C1D95]/20 focus:bg-white" />
                    </div>
                    <div>
                      <label className="block text-sm font-bold text-zinc-700 mb-1">Additional Notes</label>
                      <textarea rows="3" placeholder="Any links or documents..." className="w-full border border-zinc-200 rounded-xl px-4 py-3 bg-surface focus:outline-none focus:border-[#4C1D95]/20 focus:bg-white"></textarea>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 justify-end">
                    ...
                    <button onClick={() => setStep(3)} className="px-8 py-3 bg-[#4C1D95] hover:bg-[#22C55E] text-white rounded-xl font-bold transition-all shadow-lg">Confirm & Pay $45</button>
                  </div>
                </div>
              )}

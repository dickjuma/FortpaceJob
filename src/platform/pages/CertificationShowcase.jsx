  ...
  return (
    <>
      <div className="bg-surface-dark text-white py-20 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#4C1D95]/20 rounded-full blur-3xl -mr-40 -mt-40"></div>
        <div className="container mx-auto px-4 md:px-8 relative z-10 text-center max-w-4xl">
          <Award className="w-16 h-16 text-[#4C1D95] mx-auto mb-6" />

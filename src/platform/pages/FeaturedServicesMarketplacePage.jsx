...
const CATEGORIES = [
  { id: 1, name: 'Development & IT', icon: Code, color: 'text-[#4C1D95]', bg: 'bg-[#4C1D95]/5 dark:bg-[#4C1D95]/20' },
  { id: 2, name: 'Design & Creative', icon: Palette, color: 'text-[#4C1D95]', bg: 'bg-[#4C1D95]/5 dark:bg-[#4C1D95]/20' },
  ...
  { id: 7, name: 'Business', icon: Briefcase, color: 'text-[#4C1D95]', bg: 'bg-[#4C1D95]/5 dark:bg-[#4C1D95]/20' },
  ...
  return (
    ...
    >
      <div className="relative aspect-video overflow-hidden bg-gray-100 dark:bg-gray-800">
        ...
        {service.badge && (
          <div className="absolute top-3 left-3 px-2.5 py-1 bg-[#4C1D95] text-white text-xs font-medium rounded-full shadow-sm">
            {service.badge}
          </div>
        )}
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <h3 className="font-semibold text-gray-900 dark:text-white line-clamp-2 mb-3 group-hover:text-[#4C1D95] transition-colors leading-snug">
          {service.title}
        </h3>
...
export default function FeaturedServicesMarketplacePage() {
  ...
  return (
    <div className="min-h-screen bg-surface dark:bg-gray-950 pb-20 font-sans">
      {/* Hero Section */}
      <div className="bg-[#4C1D95] dark:bg-[#4C1D95] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10 flex flex-col items-center text-center">
          ...
          <motion.p
            ...
            className="text-[#4C1D95] text-lg md:text-xl mb-10 max-w-2xl"
          >
          ...
          >
            <div className="relative flex items-center bg-white rounded-xl shadow-xl p-2 focus-within:ring-4 focus-within:ring-#4C1D95]/30 transition-all">
              ...
              />
              <button className="bg-[#4C1D95] hover:bg-[#22C55E] text-white px-8 py-3 rounded-lg font-medium transition-colors flex-shrink-0">
                Search
              </button>
            </div>
            <div className="mt-6 flex flex-wrap justify-center gap-3 text-sm text-[#4C1D95]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            ...
            {CATEGORIES.map((cat, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white group-hover:text-[#4C1D95] transition-colors">
                    {cat.name}
                  </span>
                </motion.div>
              )
        ...
        {/* AI Recommendations */}
        <section className="bg-gradient-to-br from-teal-50 to-[#22C55E] dark:from-teal-900/20 dark:to-[#22C55E]/20 rounded-3xl p-8 md:p-10 border border-teal-100 dark:border-teal-900/30">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <button className="text-[#4C1D95] dark:text-[#4C1D95] font-medium flex items-center gap-1 hover:gap-2 transition-all self-start md:self-auto">
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              <TrendingUp className="w-6 h-6 text-[#4C1D95]" />
        ...
        <section>
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <button className="text-[#4C1D95] dark:text-[#4C1D95] font-medium flex items-center gap-1 hover:gap-2 transition-all">

      ...
      <div className="bg-white border-b border-zinc-200 sticky top-[72px] z-20">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <form onSubmit={handleSearch} className="flex gap-0 rounded-xl overflow-hidden border border-zinc-200 shadow-sm">
            ...
            <button type="submit" className="px-8 bg-[#4C1D95] hover:bg-[#22C55E] text-white font-bold text-sm">
              Search
            </button>
          </form>
                ...
                {gigs.map((row) => {
                  ...
                  return (
                    <Link
                      ...
                      className="block bg-white border border-zinc-200 rounded-xl p-4 hover:border-[#4C1D95]/40 hover:shadow-sm transition-all"
                    >
                      {g.image && (
                ...
                {jobs.map((row) => {
                  ...
                  return (
                    <Link
                      ...
                      className="block bg-white border border-zinc-200 rounded-xl p-5 hover:border-[#4C1D95]/40"
                    >
...
function EmptyState({ label }) {
  return (
    <p className="text-center text-zinc-500 py-16">
      ...
      <Link to="/find-talent" className="text-[#4C1D95] font-bold">
        Find Talent
      </Link>{' '}
      /{' '}
      <Link to="/find-work" className="text-[#4C1D95] font-bold">
        Find Work
      </Link>
      .
    </p>

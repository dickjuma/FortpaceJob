...
import { Check, Building2, User, Loader2, Shield, Sparkles, Smartphone } from 'lucide-react';
import {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 pt-28 pb-20">
      <div className="container mx-auto px-4 md:px-8 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 lg:max-w-4xl lg:mx-auto gap-6 mb-16">
          {plans.map((plan) => {
        ...
        <div className="bg-white rounded-2xl border border-zinc-200 overflow-hidden lg:max-w-5xl lg:mx-auto">

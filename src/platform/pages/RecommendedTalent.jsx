...
import { getClientOpenings, getRecommendedTalent } from '../../client/pages/find-talent/talentMarketplaceData';
    ...
    <>
      <div className="bg-surface-dark pt-16 pb-20 border-b border-zinc-800">
        <div className="container mx-auto px-4 md:px-8 text-center max-w-3xl">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#4C1D95]/10 border border-[#4C1D95]/20/20 text-[#4C1D95] font-medium mb-6">
          ...
          <div className="flex justify-center gap-4 text-sm flex-wrap">
            ...
            <div className="flex items-center gap-2 text-zinc-300 bg-white/5 px-4 py-2 rounded-lg">
              <ShieldCheck className="w-4 h-4 text-[#4C1D95]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {recommended.map((entry) => (
            <div className="relative group" key={entry.id}>
              <div className="absolute -inset-0.5 bg-gradient-to-r from-#4C1D95] to-[#22C55E] rounded-2xl opacity-50 group-hover:opacity-100 transition-opacity blur-sm" />

    ...
    <>
      <div className="bg-surface min-h-screen py-10">
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {search.newResults > 0 && (
                        <span className="bg-[#4C1D95]/10 text-[#4C1D95] text-xs font-bold px-2 py-0.5 rounded-full">
                  ...
                  <div className="flex flex-col md:items-end gap-4 md:w-48">
                    ...
                    <div className="flex items-center gap-2 w-full md:w-auto">
                      <button className="flex-1 md:flex-none justify-center flex items-center gap-1 bg-[#4C1D95]/5 hover:bg-[#4C1D95]/10 text-[#4C1D95] px-4 py-2 rounded-lg text-sm font-medium transition-colors">
          ...
          <div className="mt-8 bg-[#4C1D95]/5 border border-[#4C1D95]/20 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
            ...
            <Link to="/enterprise" className="bg-[#4C1D95] hover:bg-[#22C55E] text-white px-6 py-3 rounded-xl font-medium transition-colors whitespace-nowrap">
              Explore Enterprise
            </Link>
          </div>

    ...
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-sm font-medium text-[#4C1D95] dark:text-[#4C1D95]">50% Complete</span>
        </div>
        <div className="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-2.5">
          <div className="bg-[#4C1D95] h-2.5 rounded-full" style={{ width: '50%' }}></div>
        </div>
      </div>
          ...
          <div key={item.id} className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between">
            ...
            <div className="mt-4 sm:mt-0 w-full sm:w-auto flex justify-end">
              {item.status === 'verified' ? (
                ...
                <Link to="/verification/identity" className="flex items-center px-4 py-2 bg-[#4C1D95]/5 text-[#4C1D95] dark:bg-[#4C1D95]/20 dark:text-[#4C1D95] hover:bg-[#4C1D95]/10 rounded-lg text-sm font-medium transition-colors border border-[#4C1D95]/20 dark:border-[#4C1D95]/20/50">

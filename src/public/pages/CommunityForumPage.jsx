...
export default function CommunityForumPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-[#14a800] rounded-3xl p-8 mb-8 text-white relative overflow-hidden">
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-xl font-bold text-sm transition-colors ${
                activeCategory === cat.id ? 'bg-[#14a800]/10 text-[#14a800]' : 'text-zinc-600 hover:bg-surface'
              }`}
            >
              {cat.name}
            </button>
        ...
        <div className="flex-1">
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 border border-zinc-200 rounded-xl outline-none focus:border-[#14a800]/30"
            />
          </div>
                ...
                <article key={post.id} className="bg-white border border-zinc-200 rounded-2xl p-6 hover:shadow-md transition-shadow">
                  <div className="flex gap-4">
                    <div className="text-center shrink-0">
                      <button type="button" className="flex flex-col items-center text-zinc-500 hover:text-[#14a800]">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        ...
                        <span className="text-xs font-bold text-[#14a800] bg-[#14a800]/5 px-2 py-0.5 rounded">{post.category}</span>

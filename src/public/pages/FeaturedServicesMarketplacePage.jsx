...
const CATEGORIES = [
  { id: 1, name: 'Development & IT', icon: Code, color: 'text-[#2bb75c]', bg: 'bg-[#2bb75c]/5 dark:bg-[#2bb75c]/20' },
  { id: 2, name: 'Design & Creative', icon: Palette, color: 'text-[#2bb75c]', bg: 'bg-[#2bb75c]/5 dark:bg-[#2bb75c]/20' },
  ...
  { id: 7, name: 'Business', icon: Briefcase, color: 'text-[#2bb75c]', bg: 'bg-[#2bb75c]/5 dark:bg-[#2bb75c]/20' },
  ...
  return (
    ...
    >
      <div className="relative aspect-video overflow-hidden bg-gray-100 dark:bg-gray-800">
        ...
        {service.badge && (
          <div className="absolute top-3 left-3 px-2.5 py-1 bg-[#2bb75c] text-white text-xs font-medium rounded-full shadow-sm">
            {service.badge}
          </div>
        )}
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <h3 className="font-semibold text-gray-900 dark:text-white line-clamp-2 mb-3 group-hover:text-[#2bb75c] transition-colors leading-snug">
          {service.title}
        </h3>
...
export default function FeaturedServicesMarketplacePage() {
  ...
  return (
    <div className="min-h-screen bg-surface dark:bg-gray-950 pb-20 font-sans">
      {/* Hero Section */}
      <div className="bg-[#2bb75c] dark:bg-[#2bb75c] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10 flex flex-col items-center text-center">
          ...
          <motion.p
            ...
            className="text-[#2bb75c] text-lg md:text-xl mb-10 max-w-2xl"
          >
          ...
          >
            <div className="relative flex items-center bg-white rounded-xl shadow-xl p-2 focus-within:ring-4 focus-within:ring-#2bb75c]/30 transition-all">
              ...
              />
              <button className="bg-[#2bb75c] hover:bg-[#1d8d38] text-white px-8 py-3 rounded-lg font-medium transition-colors flex-shrink-0">
                Search
              </button>
            </div>
            <div className="mt-6 flex flex-wrap justify-center gap-3 text-sm text-[#2bb75c]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            ...
            {CATEGORIES.map((cat, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white group-hover:text-[#2bb75c] transition-colors">
                    {cat.name}
                  </span>
                </motion.div>
              )
        ...
        {/* AI Recommendations */}
        <section className="bg-gradient-to-br from-teal-50 to-[#1d8d38] dark:from-teal-900/20 dark:to-[#1d8d38]/20 rounded-3xl p-8 md:p-10 border border-teal-100 dark:border-teal-900/30">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <button className="text-[#2bb75c] dark:text-[#2bb75c] font-medium flex items-center gap-1 hover:gap-2 transition-all self-start md:self-auto">
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              <TrendingUp className="w-6 h-6 text-[#2bb75c]" />
        ...
        <section>
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <button className="text-[#2bb75c] dark:text-[#2bb75c] font-medium flex items-center gap-1 hover:gap-2 transition-all">

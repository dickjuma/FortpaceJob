  ...
  return (
    <div className="min-h-screen bg-zinc-50 pt-28 pb-16">
      <div className="max-w-3xl mx-auto px-4">
        <Link to="/" className="inline-flex items-center gap-2 text-sm font-bold text-[#4C1D95] mb-6">
          <ArrowLeft className="w-4 h-4" /> Home
        </Link>
        <div className="bg-white border border-zinc-200 rounded-2xl p-8 shadow-sm">
          <div className="flex items-start gap-4">
            <div className="w-16 h-16 rounded-xl bg-[#4C1D95]/10 flex items-center justify-center">

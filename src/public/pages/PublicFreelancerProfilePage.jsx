  ...
  return (
    <div className="min-h-screen bg-surface dark:bg-surface-dark font-sans pb-24">
      ...
      <div className="bg-surface-dark dark:bg-surface-dark text-white pt-24 pb-32 px-4 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#14a800]/20 to-transparent"></div>
          ...
          <div className="flex-1 w-full">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <button className="px-8 py-3 bg-[#14a800] hover:bg-[#14a800] font-bold rounded-xl shadow-lg shadow-[#14a800]/25/20 transition-all flex items-center gap-2">
        ...
        <div className="flex-1 space-y-8">
          ...
          <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              ...
              <button className="text-sm font-bold text-[#14a800] hover:underline">View All</button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {PORTFOLIO.map(item => (
                <div key={item.id} className="group cursor-pointer">
                  ...
                  <h3 className="font-bold text-zinc-900 dark:text-white text-sm group-hover:text-[#14a800] transition-colors">{item.title}</h3>
                </div>
              ))}
            </div>
          </div>
              ...
              {REVIEWS.map(review => (
                <div key={review.id} className="border-b border-zinc-100 dark:border-zinc-800 last:border-0 pb-6 last:pb-0">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="font-bold text-zinc-900 dark:text-white text-lg hover:text-[#14a800] transition-colors cursor-pointer">Frontend Dashboard Build (React)</h3>
        ...
        <div className="w-full lg:w-[340px] shrink-0 space-y-6">
          ...
          <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
            ...
            <div className="space-y-3">
              <button className="w-full py-3.5 bg-[#14a800] hover:bg-[#118a00] text-white font-bold rounded-xl shadow-sm transition-all text-sm">
                Invite to Job
              </button>
          ...
          <div className="bg-white dark:bg-surface-dark rounded-3xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex gap-4 items-start">
                <div className="w-10 h-10 rounded-full bg-[#14a800]/5 dark:bg-[#14a800]/10 text-[#14a800] flex items-center justify-center shrink-0">

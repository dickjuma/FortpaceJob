    ...
    <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
              <FileText className="w-5 h-5 mr-2 text-[#14a800]" /> Submitted Documents
            </h2>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-[#14a800] to-[#118a00] rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
            <div className="absolute top-0 right-0 p-4 opacity-10">
              <ShieldCheck className="w-24 h-24" />
            </div>
            <h3 className="font-bold text-lg mb-2 relative z-10">Why we need this</h3>
            <p className="text-[#14a800] text-sm mb-4 relative z-10">
              KYC helps us prevent fraud, money laundering, and ensure a secure escrow environment for all participants.
            </p>
            <ul className="text-sm text-[#14a800] space-y-2 relative z-10">
